...
| 8-9 | [ai-style-skill](ai-style-skill/) | ✅ | 实验 8-9：20 条"AI 味"纠正反馈提炼为 8 条可检查写作规则并生成 Skill；真实 `gpt-4o-mini` 只能提交候选，模型外筛选与确定性回退后，未完成任务集检出 8/8、正常文本保留集误伤 0/8，21 条候选合并为 8 条 |
