...
> Biến trajectory vận hành thành tín hiệu học đáng tin cậy để cập nhật tri thức, chỉ dẫn, chương trình và tham số trong một chu trình có thể kiểm chứng và rollback.
...
| 9-4 | Thí nghiệm đối chiếu trong văn bản | 🚧 | Tiến hóa Skill làm rõ yêu cầu và xác nhận đặc tả từ phản hồi người dùng, với thiết kế A/B ba nhánh và cổng phát hành |
...
| 9-7 | [harness-safety-gate](harness-safety-gate/) | ✅ | Thí nghiệm 9-7: cổng xác nhận thao tác rủi ro cao |
| 9-8 | [hermes-self-evolution](hermes-self-evolution/) | 📖 | Thí nghiệm 9-8: đưa cho Hermes toàn bộ cuốn sách và mã nguồn của chính nó; Hermes chọn một cải tiến, tự sửa mình và biến mỗi lần Reviewer từ chối thành một vòng học mới cho tới khi được chấp nhận |
