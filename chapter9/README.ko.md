...
> 운영 궤적을 신뢰할 수 있는 학습 신호로 바꾸고, 검증·롤백 가능한 순환을 통해 지식, 지시, 프로그램, 파라미터를 갱신합니다.
...
| 9-4 | 본문 비교 실험 | 🚧 | 사용자 피드백으로 요구사항 명확화·Spec 확인 Skill을 발전시키며, 3군 A/B 설계와 배포 게이트를 사용합니다. |
...
| 9-9 | [self-evolution-eval](self-evolution-eval/) | ✅ | 정적·추가 전용·진화형 세 방식에 대해 3개 시드와 14개 작업, 총 126회의 실제 호출을 수행합니다. [증거](self-evolution-eval/validation/latest.json)는 전이, 규칙 교체, 보존, 대응표본 통계를 담고 있습니다. |
