...
| 9-4 | [end-to-end-speech](end-to-end-speech/) | 🚧 | Están implementados el despliegue Step-Audio R1 customized-vLLM con cuatro GPU y el cliente de audio real, pero no hay endpoint Step-Audio disponible ni CUDA; la [evidencia del bloqueo](end-to-end-speech/validation/blocker.json) rechaza usar otro modelo como falso sustituto |
