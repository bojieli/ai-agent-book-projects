...
>
> A fenti három dimenzió számai egyetlen kis léptékű, kontrollált futtatásból származnak, és **szemléltető megfigyelések**: irányt állapítanak meg — a szervezés és az eszközleírások sokkal többet nyomnak a latban, mint a hangnem és a stílus —, nem pedig reprodukálható nagyságrendet. A 7. fejezet mércéje szerint egy egyszeri futtatásból származó különbséghez mintanagyság és ismétlésszám kell, mielőtt „mennyivel" típusú állítást hordozhatna. Amikor magad futtatod ezt a kísérletet, arra figyelj, stabil marad-e a három dimenzió egymáshoz mért sorrendje, nem arra, hogy ugyanazok a százalékpontok jönnek-e ki.
>
>
...
>
> **Részletes Hiba Információ**: Négy réteget tartalmaz – hiba típusa és leírása, teljes paraméter JSON, hívási verem információ és célzott javítási javaslatok (pl. FileNotFoundError esetén javasolja az elérési út ellenőrzését, a munkakönyvtár megtekintését és abszolút elérési utak használatát). Ha engedélyezve van, ez az információ az ügynök hibából való helyreállítási sikerességi arányát 60%-ról 95%-ra emeli. Ahelyett, hogy vakon újrapróbálkozna, az ügynök diagnosztizálhatja a hibát és alternatívát választhat (ez szintén egyetlen kis futtatásból származó **szemléltető megfigyelés**: azt mutatja, hogy a „részletes hibainformációt írni" irány működik, nem azt, hogy ez a nagyságrend reprodukálható).
>
