...
> **实验 8-1 ★ `[设计方案]`：Q-learning 在寻宝游戏中的表现**
>
...
> **实验 8-2 ★★ `[设计方案]`：传统 RL 与 LLM Agent 的对比研究**
>
>
...
> **实验 8-7 ★★★ `[设计方案]`：多语言思考——让模型用任意语言思考 `[扩展实验]`**
>
...
> **实验 8-11 ★★ `[外部仓库]`：GeneralPoints——单轮 RL 的 “记忆与泛化” 对照**
>
>
...
> **实验 8-13 ★★★ `[外部仓库]`：SimpleVLA-RL——结果奖励下的开放探索 `[扩展实验]`**
>
...
> **实验 8-14 ★★★ `[外部仓库]`：ReTool——代码解释器增强数学解题**
>
...
> **实验 8-15 ★★★ `[外部仓库]`：AWorld-train——在沙盒中学习使用工具**
>
