...
![图1-1 Agent 与 Environment 的闭环交互，以及 Agent 内部的 Model–Harness 结构](images/fig1-agent-environment.svg)
...
![图1-2 Agent 能力更新的三个层次](images/fig1-1.svg)
...
>
> ![图1-3 实验 1-1——上下文消融实验设计](images/fig1-2.svg)
>
...
![图1-4 Agent 轨迹——多币种汇总任务的 ReAct 循环](images/fig1-3.svg)
...
>
> ![图1-5 “模型即 Agent” 架构——原生工具调用](images/fig1-4.svg)
...
![图1-6 自主 Agent 的执行循环](images/fig1-5.svg)
