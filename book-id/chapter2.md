...
>
> Angka ketiga dimensi di atas berasal dari satu kali jalan terkendali berskala kecil dan merupakan **pengamatan ilustratif**: yang ditegakkannya adalah arah—organisasi dan deskripsi tool jauh lebih berpengaruh daripada nada dan gaya—bukan besaran yang dapat direproduksi. Menurut standar Bab 7, selisih dari satu kali jalan memerlukan ukuran sampel dan jumlah pengulangan sebelum dapat menopang klaim "seberapa jauh". Ketika Anda menjalankan sendiri eksperimen ini, perhatikan apakah urutan relatif ketiga dimensi itu stabil, bukan apakah poin persentasenya sama.
>
>
