...
3.  ★★ Ekstraksi informasi multimodal yang dibahas di Bab 4 mengubah bagan menjadi deskripsi teks sebelum *retrieval*. Proses "terjemahan" ini dapat menghilangkan hubungan spasial dalam informasi visual. Berikan contoh spesifik informasi bagan yang tidak dapat disampaikan sepenuhnya oleh deskripsi teks murni, dan rancang sebuah skema untuk melestarikan informasi tersebut.
