"""[UPDATED for Ch 10] Old Chapter 9 (multi-Agent) figure generator.

⚠️ DO NOT RUN: After the 2026-03-12 refactoring, chapter numbers changed (original Ch 9 → Ch 10).
The figures generated by this file actually correspond to the current [Chapter 10] content (multi-Agent collaboration), but are still saved as fig10-*.svg.
...
# ════════════════════════════════════════════════════════════════════
#  fig10-1: Shared context vs independent context
# ════════════════════════════════════════════════════════════════════
...
def fig10_1():
    ...
    s.save(os.path.join(OUT, 'fig10-1.svg'))


# ════════════════════════════════════════════════════════════════════
#  fig10-2: Phase-based role switching
# ════════════════════════════════════════════════════════════════════
...
def fig10_2():
    ...
    s.save(os.path.join(OUT, 'fig10-2.svg'))


# ════════════════════════════════════════════════════════════════════
#  fig10-3: Proposer-Reviewer Loop (Slidev PPT Generation)
# ════════════════════════════════════════════════════════════════════
...
def fig10_3():
    ...
    s.save(os.path.join(OUT, 'fig10-3.svg'))


# ════════════════════════════════════════════════════════════════════
#  fig10-4: Manager sequential coordination
# ════════════════════════════════════════════════════════════════════
...
def fig10_4():
    ...
    s.save(os.path.join(OUT, 'fig10-4.svg'))


# ════════════════════════════════════════════════════════════════════
#  fig10-5: Book translation Agent architecture (Exp 9.4)
# ════════════════════════════════════════════════════════════════════
...
def fig10_5():
    ...
    s.save(os.path.join(OUT, 'fig10-5.svg'))


# ════════════════════════════════════════════════════════════════════
#  fig10-6: Manager parallel coordination
# ════════════════════════════════════════════════════════════════════
...
def fig10_6():
    ...
    s.save(os.path.join(OUT, 'fig10-6.svg'))


# ════════════════════════════════════════════════════════════════════
#  fig10-7: Phone + Computer Dual Agent (Exp 9.5/9.6)
# ════════════════════════════════════════════════════════════════════
...
def fig10_7():
    ...
    s.save(os.path.join(OUT, 'fig10-7.svg'))


# ════════════════════════════════════════════════════════════════════
#  fig10-8: Parallel Web Scraping Agent (Exp 9.7)
# ════════════════════════════════════════════════════════════════════
...
def fig10_8():
    ...
    s.save(os.path.join(OUT, 'fig10-8.svg'))


# ════════════════════════════════════════════════════════════════════
#  fig10-9: Handoff Chain Pattern
# ════════════════════════════════════════════════════════════════════
...
def fig10_9():
    ...
    s.save(os.path.join(OUT, 'fig10-9.svg'))


# ════════════════════════════════════════════════════════════════════
#  fig10-10: MetaGPT SOP Pipeline
# ════════════════════════════════════════════════════════════════════
...
# ════════════════════════════════════════════════════════════════════
#  Fig10-11: VLA Architecture (Vision-Language-Action) — Comparison of Three Technical Paths
# ════════════════════════════════════════════════════════════════════
...
def fig10_11():
    ...
    s.save(os.path.join(OUT, 'fig10-11.svg'))


# ════════════════════════════════════════════════════════════════════
#  Fig 10-12: Voice Werewolf Agent System (Exp 9.9)
# ════════════════════════════════════════════════════════════════════
...
def fig10_12():
    ...
    s.save(os.path.join(OUT, 'fig10-12.svg'))
