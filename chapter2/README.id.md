...
| 2-2, 2-8 | [attention_visualization](attention_visualization/) | ✅ | Memvisualisasikan token input/output dan distribusi bobot attention model. |
...
| 2-9 | [system-hint](system-hint/) | ✅ | Menguji pengaruh System Hints terhadap perilaku dan kinerja Agent. |
| 2-10 | [context-compression](context-compression/) | ✅ | Membandingkan beberapa strategi kompresi untuk mengurangi token tanpa kehilangan kemampuan utama. |
