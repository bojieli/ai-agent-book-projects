...
| 2-2, 2-8 | [attention_visualization](attention_visualization/) | ✅ | Визуализирует полную входную/выходную последовательность токенов и распределение весов внимания LLM, давая глубокое понимание того, как модель обрабатывает контекст, рассуждает и вызывает инструменты. |
...
| 2-9 | [system-hint](system-hint/) | ✅ | Изучает влияние системных подсказок (System Hints) на поведение агента, исследуя, как повысить качество за счёт оптимизации системного промпта. |
| 2-10 | [context-compression](context-compression/) | ✅ | Реализует и сравнивает несколько стратегий сжатия контекста: суммаризацию, извлечение ключевой информации и семантическое сжатие. Снижает расход токенов, сохраняя возможности агента. |
## Типы проектов
