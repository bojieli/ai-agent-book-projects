...
| 3-3 | [log-sanitization](log-sanitization/) | ✅ | Реализует интеллектуальную систему очистки логов, защищающую чувствительные данные при сохранении отладочной информации. |
## Типы проектов
