...
| 2-2, 2-8 | [attention_visualization](attention_visualization/) | ✅ | Visualización de la secuencia completa de tokens y pesos de atención de LLM |
...
| 2-9 | [system-hint](system-hint/) | ✅ | Estudio del impacto de los prompts de sistema en el comportamiento del Agente |
| 2-10 | [context-compression](context-compression/) | ✅ | Comparación de estrategias de resumen, extracción de información clave y compresión semántica de contexto |
