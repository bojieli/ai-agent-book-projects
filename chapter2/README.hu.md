...
| 2-2, 2-8 | [attention_visualization](attention_visualization/) | ✅ | Megjeleníti a bemeneti és kimeneti tokeneket, valamint a modell figyelmi súlyainak eloszlását. |
...
| 2-9 | [system-hint](system-hint/) | ✅ | A System Hints ágensviselkedésre és teljesítményre gyakorolt hatását vizsgálja. |
| 2-10 | [context-compression](context-compression/) | ✅ | Több tömörítési stratégiát hasonlít össze a tokenhasználat csökkentésére az alapvető képességek megőrzése mellett. |
