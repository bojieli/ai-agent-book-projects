# الفصل السابع · نموذج ما بعد التدريب

> نظرة شاملة للمراحل الثلاث: التدريب المسبق، SFT، وRL. متى تختار SFT مقابل RL وRLHF ومقارنة الخوارزميات والبيانات والبيئات والاستكشاف المتطور في استدعاء أدوات نماذج التدريس وتحسين كفاءة العينة.
...
| 7-15 | [إعادة أداة](retool/) | 📖 | يستخدم حوارًا متعدد المنعطفات وصندوق حماية الكود لتعزيز قدرة التفكير الرياضي لنماذج اللغات الكبيرة. ومن خلال عملية التدريب المكونة من مرحلتين SFT وRL، يتعلم النموذج كيفية استخدام بيئة تنفيذ التعليمات البرمجية للمساعدة في حل المشكلات الرياضية. استنادًا إلى Qwen2.5-32B-Instruct، الذي تم تدريبه على مجموعة بيانات AIME 2024، باستخدام خوارزمية DAPO ووضع الحماية SandboxFusion. |
| 7-16 | `AWorld/` · [Aالقطار العالمي](AWorld-train/) | 📖 | يقوم بتدريب الوكلاء المتجسدين بناءً على إطار عمل AWorld، مما يمكّن الوكلاء من أداء مهام معقدة في بيئة افتراضية والتعلم من الخبرة. |
