...
| 7-6 | [sesame](sesame/) | ✅ | Сфокусирован на методах обучения и оценки для задач моделирования последовательностей. |
| 7-6 | [orpheus](orpheus/) | ✅ | Обучает модели генерации и понимания музыки. |
