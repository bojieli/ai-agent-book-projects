...
| 7-18 | [curly-quote-sft](curly-quote-sft/) | ✅ | Scope-sensitive SFT китайских кавычек на открытой Qwen3-8B с GPU. |
| 7-19 | [exact-copy-sft](exact-copy-sft/) | ✅ | Byte-exact SFT копирования специальных строк на открытой Qwen3-8B с GPU. |
