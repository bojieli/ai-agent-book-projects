...
실험 7-17에서는 코딩 에이전트 bad case 24개로 Qwen2.5-7B LoRA 어댑터를 학습했습니다. ‘완료’와 ‘계속 검증’의 고정 비교에서 미완료 작업의 정답률은 3/12에서 11/12로 올랐고, 완료 작업 보류 세트는 8/8을 유지했습니다. 자유 생성은 지나치게 신중해졌으므로, 고정 비교를 주 결과로 삼으며 운영 전체의 성공률 향상으로 해석하지 않습니다.
