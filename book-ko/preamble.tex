...
% Internal cross-reference links (그림 N-M / 제N장) — clickable + subtle teal,
...
\newtcolorbox{questionbox}{
  ...
  title={\sffamily\bfseries 깊이 생각해 보기},
...
% Override the reader-facing chapter wrapper and table-of-contents label.
\ctexset{chapter={name={제,장},number=\arabic{chapter}}}
