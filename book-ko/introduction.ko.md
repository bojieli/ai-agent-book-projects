...
책에 나오는 실험 수치는 두 종류이며, 독자는 서로 다른 강도로 받아들이면 됩니다. **하나는 재현 가능한 출처가 있는 것**입니다. 표본 수, 실행 횟수, 신뢰구간 가운데 하나가 제시되어 있거나, 부속 저장소에 실행 기록과 원본 출력이 남아 있습니다. 7~9장의 실험은 대부분 이쪽입니다. **다른 하나는 예시적 관찰**입니다. 한 번의 소규모 대조 실행에서 나온 것으로 방향과 메커니즘을 보여 줄 뿐, "어떤 방안이 다른 방안보다 몇 포인트 높다"는 크기 주장을 뒷받침하지는 못합니다. 이런 수치는 실험 상자 안에서 명시적으로 밝혀 둡니다. 왜 이 구분이 중요한지는 7장에서 따로 다룹니다. 한 번 실행해서 나온 몇 퍼센트포인트 차이는 흔히 통계적 잡음 안에 들어가기 때문입니다.
