...
- **Tần suất thay đổi**: Các khả năng thay đổi thường xuyên thường nhẹ hơn khi được viết và phân phối dưới dạng Skill, còn những thao tác nền tảng ổn định phù hợp hơn với công cụ chuyên dụng. Tuy nhiên, việc văn bản dễ chỉnh sửa chỉ nói lên định dạng phân phối nhẹ hơn, không có nghĩa thay đổi đó ít rủi ro hơn.
...
**Hãy xử lý thay đổi Skill như thay đổi mã.** Dù Skill là tài liệu ngôn ngữ tự nhiên, nó có thể chỉ dẫn Agent chạy lệnh shell, triển khai dịch vụ, sửa cơ sở dữ liệu hoặc gọi công cụ đặc quyền, nên tác động vận hành có thể giống hệt một thay đổi chương trình. Vì vậy Skill phải được quản lý phiên bản, ghi rõ nguồn gốc, chủ sở hữu và quyền áp dụng, đồng thời trải qua peer review cùng kiểm tra lint/schema tự động. Trước khi merge, hãy chạy tác vụ đại diện và kiểm thử hồi quy trong sandbox; phát hành theo từng giai đoạn hoặc canary và giữ sẵn phiên bản rollback có thể dùng ngay. Thay đổi liên quan đến ghi production, tiền, thông tin xác thực hoặc hành động có hệ quả khác phải được phê duyệt bổ sung. Quản trị cấp độ mã giữ lại tốc độ viết và phân phối Skill, đồng thời tạo một ranh giới an toàn có kiểm soát cho tốc độ đó.
