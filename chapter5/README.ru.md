...
| 5-12 | [agent-creator](agent-creator/) | ✅ | Метапрограммирующий агент сравнивает адаптацию проверенной эталонной реализации с генерацией агента с нуля; обе ветви компилируются, тестируются и проверяются реальным API Kimi K3 с вызовами инструментов. |
## Типы проектов
