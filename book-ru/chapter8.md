...
>
> **Цель:** Выделить способность, которую представляет этот эксперимент, и сравнить её с подходящим базовым уровнем.
>
> **Вывод на уровне принципа:** Изменение принимается только тогда, когда целевое поведение улучшается без регрессий, а результат остаётся атрибутируемым, проверяемым и обратимым; книга описывает замысел и вывод, а не параметры отдельного запуска.
>
...
> **Эксперимент 8-9 ★★: превращаем обратную связь в Skill для письма**
>
> **Цель:** Выделить способность, которую представляет этот эксперимент, и сравнить её с подходящим базовым уровнем.
>
> **Вывод на уровне принципа:** Изменение принимается только тогда, когда целевое поведение улучшается без регрессий, а результат остаётся атрибутируемым, проверяемым и обратимым; книга описывает замысел и вывод, а не параметры отдельного запуска.
...
> **Эксперимент 8-6 ★★★: Дать Hermes эту книгу: сможет ли он обновить самого себя?**
>
> **Цель:** Выделить способность, которую представляет этот эксперимент, и сравнить её с подходящим базовым уровнем.
>
> **Вывод на уровне принципа:** Изменение принимается только тогда, когда целевое поведение улучшается без регрессий, а результат остаётся атрибутируемым, проверяемым и обратимым; книга описывает замысел и вывод, а не параметры отдельного запуска.
...
> **Эксперимент 8-7 ★★★: оценка непрерывной эволюции Agent**
>
> **Цель:** Выделить способность, которую представляет этот эксперимент, и сравнить её с подходящим базовым уровнем.
>
> **Вывод на уровне принципа:** Изменение принимается только тогда, когда целевое поведение улучшается без регрессий, а результат остаётся атрибутируемым, проверяемым и обратимым; книга описывает замысел и вывод, а не параметры отдельного запуска.
