...
3. ★★ Мультимодальное извлечение информации, описанное в главе 4, преобразует диаграммы в текстовые описания перед поиском. Этот процесс «перевода» может терять пространственные отношения из визуальной информации. Приведите конкретный пример информации на диаграмме, которую невозможно полностью передать чисто текстовым описанием, и предложите способ сохранения этой информации.
