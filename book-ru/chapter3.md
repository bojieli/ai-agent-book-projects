...
10. ★★★ Спроектируйте для Markdown-базы памяти пользователя и инкрементальное обновление, и периодическую реорганизацию. Какие ошибки всё ещё могут попасть в слияние, если Reviewer и Proposer используют одну модель, а Reviewer видит только выбранные Proposer фрагменты диалогов? Предложите улучшения с точки зрения независимости моделей, охвата свидетельств и прав на инструменты.
