...
В зависимости от задачи агента среды оценки можно грубо разделить на два типа: с вызовом инструментов и с взаимодействием человека и машины.
...
Ниже мы возьмём пользовательскую память как конкретный случай и покажем, как перевести этот общий метод в исполняемый набор оценки и оценщик.
