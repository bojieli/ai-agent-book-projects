...
Всё, о чём шла речь до сих пор, рассматривалось с инженерной точки зрения: как заставить группу агентов сообща довести задачу до конца. Следующий раздел **отличается по жанру от остальной книги**: предыдущие девять с половиной глав отвечают на вопрос «как это построить», а он — на вопрос «что сейчас пробуют». Это обзор нынешних экспериментов с обществами агентов; он даёт наблюдения и открытые вопросы, а не инженерный рецепт, который можно повторить напрямую. Он остаётся в этой главе потому, что эти эксперименты доводят до предельного масштаба ровно то, что обсуждалось выше, — разделение контекста, топологию сотрудничества, режимы отказов, — и потому, что для двух из них (городок ИИ Стэнфорда и голосовая «Мафия») книга даёт воспроизводимые и запускаемые сопутствующие проекты. Читайте его как стресс-тест предыдущих инженерных выводов на куда большем временном масштабе.
...
Это ещё и последняя глава основного текста. От «Агент = LLM + контекст + инструменты» в главе 1, через построение, оценку и эволюцию, до сотрудничества в этой главе инженерный маршрут пройден. Но остаются два вопроса, на которые сама инженерия ответить не может: сколько от сегодняшнего Harness уцелеет по мере усиления моделей и можно ли знание, принадлежащее конкретному пользователю и конкретной компании, восполнить «ещё одним обучением». Послесловие берётся за оба.
