...
> **Эксперимент 6-9 ★ `[Реальное железо]`: уборка стола дистанционным управлением настоящим XLeRobot**
>
...
> **Эксперимент 6-11 ★★ `[Реальное железо]`: пусть Gemini Robotics-ER 1.5 автономно приберёт стол с помощью XLeRobot**
>
