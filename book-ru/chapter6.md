...
В сопутствующем эксперименте все три системы прошли одни и те же 60 вопросов; сохранено 180 реальных траекторий API. В таблице 6-3 проценты приведены вместе с числом успешных случаев.

Таблица 6-3. Успешность систем памяти по уровням задач
...
> **Эксперимент 6-5 ★★: Оценка границ префикса в нескольких представлениях**
>
...
> **Эксперимент 6-6 ★★: Построение полностью автоматизированного конвейера оценки качества TTS**
>
...
> **Эксперимент 6-7 ★★: построение рейтинга моделей на основе данных парных сравнений**
>
...
> **Эксперимент 6-8 ★★: Измерение порога действия модели в фиксированном Coding Harness**
>
...
> **Эксперимент 6-9 ★: сквозной анализ стоимости задач агента**
>
...
> **Эксперимент 6-10 ★★: многомерное бенчмарк-тестирование производительности моделей**
>
...
>
> **Эксперимент 6-11 ★★: сквозная оценка выбора системы памяти пользователя**
>
...
Таблица 6-5 суммирует измеренные результаты. Четырёх задач на ветвь достаточно, чтобы решить, стоит ли расширять запуск, но не для оценки всего AndroidWorld.

Таблица 6-5. Три раунда на Wi-Fi-срезе AndroidWorld
...
> **Эксперимент 6-12 ★★★: оценка и улучшение AndroidWorld**
>
...
> **Эксперимент 6-13 ★★: настройка воплощённой интеллектуальной среды с OpenVLA и RoboTwin2**
>
