...
Эти пять этапов не заменяют друг друга, а вложены слой за слоем: инженерия промптов — подмножество инженерии контекста, инженерия контекста — подмножество Harness-инженерии, Harness-инженерия — подмножество Loop-инженерии, а Loop-инженерия — подмножество Graph-инженерии: отдельный цикл агента является узлом графа исполнения. Каждый слой расширяет круг внимания и влияния инженера, опираясь на предыдущий. **Когда способности разных моделей становятся всё ближе друг к другу и перестают быть решающим фактором различия, конкурентное преимущество смещается к инженерным практикам за пределами модели.**
