...
> **Эксперимент 9-4 ★★★ `[Только проект]`: создание проверяемого рабочего процесса из браузерной траектории**
>
...
> **Эксперимент 9-8 ★★ `[Внешний репозиторий]`: подтверждение опасных операций по обратной связи пользователей**
>
