...
В главе 7 на примере τ-bench/τ²-bench было показано, как оценивают агента службы поддержки авиакомпании: пользователь раскрывает требования постепенно, а система проверяет и состояние среды (например, бронирование), и то, прозвучала ли в диалоге необходимая информация. Атрибуция сбоев в той же главе подчёркивала: недостаточно записать «неудача», нужно найти **первый ошибочный шаг**.
