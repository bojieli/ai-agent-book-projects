...
| 8 | 🔄 **Evolusi Berkelanjutan Agent** | Belajar dari jejak eksekusi dan memperbarui pengetahuan, instruksi, program, serta parameter | [Baca](../../book-id/chapter8.md) | [9](../../chapter8/README.id.md) |
| 9 | 🎙️ **Interaksi Multimodal dan Waktu Nyata** | Suara, GUI, Computer Use, dan robotika | [Baca](../../book-id/chapter9.md) | [12](../../chapter9/README.id.md) |
