...
**[中文](../../README.md) · English ← current · [正體中文](../zh-TW/README.md) · [Русский](../ru/README.md) · [Tiếng Việt](../vi/README.md) · [தமிழ்](../ta/README.md) · [日本語](../ja/README.md)**
...
| 📚 **10 chapters** of text, from basics to production | 📂 **92** companion projects (70+ standalone) | 🌐 **7 languages**: CN / EN / zh-TW / RU / TA / VI / JA |
| :---: | :---: | :---: |
...
Chinese text source is in [`book/`](../../book/); English/Traditional Chinese (Taiwan)/Russian/Tamil/Vietnamese/Japanese versions are community contributions (may lag behind the Chinese original), located in [`book-en/`](../../book-en/), [`book-zhtw/`](../../book-zhtw/), [`book-ru/`](../../book-ru/), [`book-ta/`](../../book-ta/), [`book-vi/`](../../book-vi/), [`book-ja/`](../../book-ja/) respectively.

The shared builder produces EPUB 3 editions for Simplified Chinese, English, Traditional Chinese (Taiwan), Russian, Tamil, Vietnamese, and Japanese. See the [EPUB build instructions](../../EPUB.md).
