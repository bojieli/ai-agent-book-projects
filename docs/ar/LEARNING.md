...
- **الفصل الثامن · التطور الذاتي**: تمكين الوكلاء من النمو بالخبرة دون تغيير الأوزان؛ من التعلم من التجارب، إلى تحويل مسارات العمل إلى أدوات، ثم تقطير المطالبات والملاحظات داخل المعلمات. **الفكرة الأساسية**: التعلم من الخبرة هو مفتاح انتقال الوكيل من «الذكاء» إلى «المهارة».
...
- **متقدم** (الفصول 5-6): يتطلب مهارات برمجة قوية، ويتضمن تصميم نظام معقد.
- **خبير** (الفصول 7-8): يتطلب التعلم العميق والتدريب/خبرة التطور الذاتي.
- **التطبيق** (الفصول 9-10): التطبيق الشامل للمعرفة السابقة لبناء التطبيقات العملية.

## اقتراحات عملية

1.  **التدريب العملي**: تم تصميم كل مشروع ليتم تشغيله بشكل مستقل. يوصى بتشغيل الكود وتعديله بنفسك.
2.  **ادمجها مع الكتاب**: اقرأ الفصول المقابلة في المخطوطة في دليل [`book-ar/`](../../book-ar/) (العربية) أو دليل [`book/`](../../book/) (الأصل الصيني) لهذا المستودع لفهم الجمع بين النظرية والتطبيق.
3.  **المقارنة التجريبية**: تتضمن العديد من المشاريع دراسات الاستئصال والتجارب المقارنة. تعميق الفهم من خلال المقارنة.
