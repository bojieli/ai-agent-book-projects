...
← [영문 메인 README로 돌아가기](../en/README.md) · [중문 메인 README](../../README.md)

## 핵심 개념: Agent = Model + Context + Tools

이 책의 핵심 틀은 **Agent = Model + Context + Tools**입니다. 세 요소가 함께 작동해 에이전트의 지능적 행동을 구현합니다.

| 요소 | 비유 | 역할 |
| :--: | :--: | --- |
| 🧠 **모델(Model)** | 두뇌 | 이해, 사고(reasoning), 의사결정 능력을 제공합니다. |
| 💾 **컨텍스트(Context)** | 운영체제 | 시스템 지침, 대화 기록, 사고 과정, 도구 상호작용 기록 등을 담습니다. |
| 🤲 **도구(Tools)** | 양손 | 환경을 인식하고 작업을 실행하며 외부 세계와 상호작용합니다. |
...
| 부분 | 장 | 주요 내용 | 핵심 통찰 |
| --- | :--: | --- | --- |
| **기초** | 제1장 | 강화학습에서의 에이전트 정의, 전통적 RL과 LLM+RL의 샘플 효율성 비교, ‘모델이 곧 에이전트’라는 새로운 패러다임 | 사전 지식의 중요성은 알고리즘과 환경을 뛰어넘습니다. |
...
| # | 팁 | 설명 |
| :--: | --- | --- |
| 1 | 🛠️ **직접 실습하기** | 각 프로젝트는 독립적으로 실행할 수 있도록 설계되어 있습니다. 코드를 직접 실행하고 수정해 보세요. |
| 2 | 📚 **책과 함께 보기** | 영어판 [`book-en/`](../../book-en/), 일본어판 [`book-ja/`](../../book-ja/), 또는 중국어 원문 [`book/`](../../book/)에서 해당 장을 함께 읽으며 이론과 실습의 연결을 이해해 보세요. |
