...
實驗 7-17 使用 24 個 coding agent bad case 訓練 Qwen2.5-7B LoRA adapter。在「完成」與「繼續驗證」的固定比較中，未完成任務的正確判斷由 3/12 提升到 11/12，已完成任務保留集維持 8/8。自由生成變得過度謹慎，因此固定比較才是主要結果，不能據此宣稱線上整體成功率提升。
