...
شغّلت التجربة المصاحبة الأنظمة الثلاثة على الأسئلة الستين نفسها، واحتفظت بـ180 مسارًا حقيقيًا لاستدعاءات API. يعرض الجدول 6-3 النسب وأعداد الإجابات الناجحة معًا.

الجدول 6-3 معدل النجاح بحسب نظام الذاكرة ومستوى المهمة
...
> **التجربة 6-5 ★★: تقييم حدود بادئة المسار بتمثيلات متعددة**
>
...
> **التجربة 6-6 ★★: إنشاء خط أنابيب لتقييم جودة تحويل النص إلى كلام (TTS) مؤتمت بالكامل**
>
...
> **التجربة 6-7 ★★: إنشاء لوحة صدارة نموذجية من بيانات المقارنة الزوجية**
>
...
> **التجربة 6-8 ★★: قياس عتبة فعل النموذج داخل Coding Harness ثابت**
>
...
> **التجربة 6-9 ★: تحليل التكلفة الشاملة لمهام الوكيل**
>
...
> **التجربة 6-10 ★★: قياس أداء النموذج متعدد الأبعاد**
>
...
>
> **التجربة 6-11 ★★: تقييم الاختيار الشامل لأنظمة ذاكرة المستخدم**
>
...
يلخص الجدول 6-5 النتائج المقاسة. ومع أربع مهام فقط في كل فرع، تكفي هذه الأرقام لتقرير جدوى تشغيل أوسع، لكنها لا تقدّر النجاح على AndroidWorld كله.

الجدول 6-5 ثلاث جولات على شريحة Wi-Fi من AndroidWorld
...
> **التجربة 6-12 ★★★: التقييم والتحسين في AndroidWorld**
>
...
> **التجربة 6-13 ★★: تكوين بيئة الذكاء المضمنة لـ OpenVLA وRoboTwin2**
>
