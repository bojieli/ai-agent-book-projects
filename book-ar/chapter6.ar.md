...
إذا كان المطلوب فقط تحديد ما إذا كان المستخدم قد أنهى كلامه، فيمكن دمج قرار نهاية الدور مباشرة في أداة التعرف المتدفقة. ويجب ألا تستخدم تسميات التدريب إلا المعلومات المتاحة لحظة اتخاذ القرار؛ وإلا أنتجت معرفة ما بعد الحدث حكماً لا يمكن تكراره على الإنترنت. وهذا مسار أخف من نموذج لغوي صوتي كامل.
...
حتى مع الإدراك المتدفق، تمرر السلسلة السماع والتفكير والكلام عبر واجهات منفصلة، وقد تضيع العاطفة والتنغيم والصوت المحيط عند تحويل الصوت إلى نص. يستمع Omni ويولد الرد وينطقه بنموذج واحد، مع كلفة تدريب وتصحيح واستبدال أعلى (الشكل 6-9). ميزته الأساسية هي زمن الاستجابة وحفظ المعلومات غير النصية، لا دقة أعلى بالضرورة: قد تصحح السلسلة الذاتية خطأً إدراكيًا عندما يكفي النص، لكنها تفقد الدليل نهائيًا إذا اعتمدت الإجابة على سرعة الكلام أو عاطفته أو البيئة.
