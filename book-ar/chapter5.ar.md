...
في المقارنات باستخدام نفس مجموعة الموجّهات، أنتجت هذه الآلية **صفرًا من عمليات الكتابة التي تنتهك الثوابت المعلنة**، في حين أن SQL، والشيكات المكتوبة بـ LLM، والموجّهات الدستورية، واعتراضات حدود الإجراء، تسمح كل منها بالمرور في أي مكان من حفنة إلى عشرات الانتهاكات. ليس "من المرجح أن يكون صحيحًا" ولكن "من المستحيل أن يكون مخطئًا" بتكلفة حوالي 2 ميلي ثانية إضافية لكل كتابة. وبطبيعة الحال، فإن الضمان مشروط: يجب أن يلتقط المخطط جميع الثوابت المطلوبة، ويجب أن يحظر النشر كل مسار يمكن من خلاله للطبقة غير الموثوقة تجاوز التخزين والاتصال مباشرة بقاعدة البيانات. بالنسبة لوكلاء البرمجة، يؤدي هذا إلى مبدأ معماري مهم: **عندما يكون كل من كاتب الكود ومشغل الكود غير موثوقين، لا يمكن أن توجد قيود موثوقة حقًا في الكود الذي تم إنشاؤه، ولكن يجب وضعها في الأساس الذي يراجعه الإنسان تحته** - هذا هو الشكل النهائي لمبدأ "القيود على التوجيه" من الفصل الأول، المطبق على طبقة البيانات.
...
بعد التنفيذ، يدخل الوكيل على الفور في مرحلة ضمان الجودة القائمة على الاختبار - حيث يقوم بكتابة حالات اختبار للوظيفة الجديدة أو المعدلة، والتي تغطي المسارات العادية وشروط الحدود وسيناريوهات الخطأ. بعد كتابة الاختبارات، يقوم الوكيل بتنفيذ مجموعة الاختبار. إذا فشلت الاختبارات، فلا يجب على الوكيل إبلاغ المستخدم بالفشل فحسب، بل يجب عليه تحليل السبب وتحديد المشكلة وتعديل التعليمات البرمجية حتى تنجح جميع الاختبارات. قد تتطلب حلقة "الإصلاح الاختباري" هذه عدة تكرارات، وهذه القدرة على التصحيح الذاتي هي التي ترفع مستوى وكيل البرمجة من مولد التعليمات البرمجية إلى مساعد هندسي موثوق. على العكس من ذلك، فإن الطريقة الأكثر شيوعًا التي يتباطأ فيها وكيل البرمجة هي تخطي هذه المرحلة تمامًا - كتابة الكود والإبلاغ عن "اكتمال المهمة" دون إجراء الاختبارات على الإطلاق. تعريف "اجتياز الاختبارات" بدلاً من "كتابة التعليمات البرمجية"، حيث أن معيار الإكمال هو على وجه التحديد مبدأ Loop Engineering المتمثل في السماح للتحقق بتحديد متى يكون التوقف آمنًا، ويتم تطبيقه على الترميز (يناقش الفصل العاشر هذه الفئة من "الإنهاء المبكر" بشكل منهجي).
...
بالعودة إلى السؤال الفكري الخاص بالفصل الأول، يمكن أن يصبح الوكيل محاصرًا في حلقة ليس فقط بسبب فقدان نتائج الأداة ولكن أيضًا بسبب تكرار أخطاء الأداة المتطابقة، أو الاستدعاءات الهلوسة، أو ضغط السياق الذي يفقد حالة المفتاح، أو مهمة غير قابلة للحل. يعتمد الاكتشاف على "تصنيف الأخطاء + التعرف على الأنماط"، والاسترداد على "التصعيد المتدرج"، والإنهاء على "قواطع الدائرة + الحدود القصوى الشاملة + التصعيد البشري" - وهذه معًا هي إجابة Harness الكاملة على "قد يعمل الوكيل إلى الأبد". ما تحله هذه الآليات ليس "القدرة النموذجية غير الكافية" ولكن "متانة النظام في ظل الظروف الحدودية": ستستمر النماذج في التزايد، لكن الشبكات ستنخفض، وستتوقف العمليات، وسيقوم المستخدمون بأشياء غير متوقعة. والأهم من ذلك، **لا يتم تحديد موثوقية الوكيل من خلال ما إذا كان يرتكب أخطاء، ولكن من خلال ما إذا كان لكل فئة من الأخطاء مسار اكتشاف واسترداد وإنهاء مناسب**.
