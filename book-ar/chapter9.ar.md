# تعدد الوسائط والتفاعل في الوقت الحقيقي

استكشفت الفصول السابقة كيفية عمل الوكلاء في عالم قائم على النصوص، والتفاعل مع الأنظمة الرقمية من خلال السياق والأدوات والتعليمات البرمجية. لكن عالم الوكيل يمتد إلى ما هو أبعد من النص وواجهات برمجة التطبيقات. في اللحظة التي يحتاج فيها إلى فهم أمر منطوق، أو العثور على الزر الأيمن على الشاشة والنقر عليه، أو توجيه ذراع آلية للإمساك بجسم ما، فإنه يدخل منطقة جديدة: **تفاعل متعدد الوسائط في الوقت الفعلي**. يعد هذا التحول من إدخال وإخراج النص الخالص إلى **الإدراك متعدد الوسائط والاستجابة في الوقت الفعلي** هو الخطوة الحاسمة التي تأخذ العميل إلى ما هو أبعد من "مربع الحوار". "متعدد الوسائط" يعني ببساطة التعامل مع أشكال متعددة من المعلومات في وقت واحد - النص والكلام والصور والفيديو والإجراءات - بدلاً من النص وحده.

أولا، دعونا نحدد نطاق هذا الفصل. لقد أصبح فهم الصور الثابتة والمستندات — فحص لقطة الشاشة أو قراءة المخطط أو تحليل ملف PDF — جزءًا طبيعيًا من سير عمل الوكيل في الفصول السابقة. بالنسبة إلى نماذج LLM متعدد الوسائط اليوم، فإن مهام الفهم ذات المدخلات الفردية هذه ناضجة نسبيًا ولا تتطلب بنية خاصة. يتناول هذا الفصل فئة مختلفة من المشكلات: ثلاثة سيناريوهات فيها **قيود الوقت الفعلي تجعل المشكلات متعددة الوسائط صعبة** - الحوار الصوتي، وتشغيل واجهة المستخدم الرسومية، والتحكم في الروبوت. في هذه الإعدادات، تصل المدخلات بشكل مستمر ويجب أن تلبي المخرجات ميزانية زمنية صارمة، مما يؤدي إلى تغيير البنية بشكل أساسي. يظل الفهم الفوري للتدفقات المرئية المستمرة أو الفيديو يمثل مشكلة مفتوحة للوكلاء في وقت كتابة هذا التقرير. سنعود إليه عندما يفحص قسم استخدام الكمبيوتر حدود لقطات الشاشة إطارًا تلو الآخر، ومرة ​​أخرى في أسئلة نهاية الفصل. هناك حدود أخرى: في إطار هذا الكتاب، يعد **إنشاء الوسائط المتعددة** (إنشاء الصور أو الفيديو) مجرد استدعاء أداة عادية، كما تم تناوله في الفصل الخامس حول إنشاء الوسائط المتعددة. يستخدمه العميل كأداة خارجية، لذا فهو لا يثير أيًا من تحديات التفاعل في الوقت الفعلي التي تم تناولها هنا ويظل خارج الموضوع الرئيسي للفصل.

قد يبدو التفاعل الصوتي، واستخدام الكمبيوتر، وتشغيل الروبوت وكأنها ثلاثة مجالات مختلفة تمامًا، ولكن الأنظمة في الثلاثة تواجه مشكلات متشابهة بشكل لافت للنظر: يجب عليها معالجة عدة طرائق في وقت واحد، كما أنها حساسة للغاية لزمن الوصول. إن التوقف لمدة تزيد عن ثانيتين في المحادثة الصوتية يجعل الأشخاص يشعرون بالقلق؛ يمكن أن يتسبب الارتعاش على مستوى المللي ثانية في التحكم في الروبوت في حدوث تصادم. تدفع هذه القيود معًا السيناريوهات الثلاثة في نفس الاتجاه المعماري: بعيدًا عن **خط الأنابيب التسلسلي** (مثل خط تجميع المصنع، حيث يجب أن تنتهي خطوة واحدة قبل أن تبدأ الخطوة التالية) ونحو **النموذج الشامل** (نموذج موحد ينتقل مباشرة من المدخلات إلى المخرجات، مما يلغي عمليات التسليم الوسيطة).
...
اعتمد المساعدون الصوتيون الأوائل هذا المسار التسلسلي المكون من أربع مراحل لسبب بسيط: لا يوجد نموذج واحد يمكنه التعامل في الوقت نفسه مع التعرف على الكلام وفهم اللغة والتفكير وتركيب الكلام. سمحت البنية المعيارية بتطوير كل مكون وتحسينه بشكل مستقل. ومع ذلك، فإن تكلفة النمطية هي زمن الاستجابة المتراكم - يجب أن تنتظر كل مرحلة حتى تكتمل المرحلة السابقة قبل أن تبدأ.

**VAD** يقع في بداية المسار ويراقب التدفق الصوتي بشكل مستمر. خيار التصميم الرئيسي الخاص بها هو اكتشاف نهاية الكلام: تستخدم الأنظمة عادةً حد الصمت المستمر الذي يتراوح بين 500 و800 مللي ثانية. إذا توقف المستخدم عن التحدث لأكثر من نصف ثانية، يعتبر نظام مساعدة المساعدة (VAD) أن الكلام قد اكتمل. يقدم هذا المصدر الأول للكمون ويفرض مقايضة صعبة: إذا كانت العتبة قصيرة جدًا، فقد يتم الخلط بين توقف التفكير ونهاية الكلام، مما يؤدي إلى اختصار الجملة؛ إذا كانت طويلة جدًا، فيجب على المستخدم الانتظار لمدة ثانية تقريبًا بعد الانتهاء قبل تلقي الرد.

**ASR** يحول الشكل الموجي الصوتي إلى نص. نماذج مثل Whisper وSenseVoice، عند نسخ 5 ثوانٍ من الصوت باستخدام نموذج صغير إلى متوسط ​​الحجم منتشر على وحدة معالجة الرسومات، عادةً ما تستغرق من 50 إلى 200 مللي ثانية؛ يمكن أن تستغرق النماذج الأكبر حجمًا أو عمليات النشر المحدودة الموارد ما بين 200 إلى 500 مللي ثانية (تندرج مجموعة التحكم في التجربة 9-3 ضمن الفئة الأخيرة). المشكلة الأكثر خطورة: طوال فترة انتظار VAD ونسخ ASR، يبقى LLM في وضع الخمول تمامًا - فهو لم يتلق شيئًا ولا يمكنه البدء في التفكير مبكرًا.

**LLM**، حتى لو تم تحسينه بشكل جيد، فإن وقت ظهور أول رمز مميز (TTFT) يتراوح بين 100-500 مللي ثانية اعتمادًا على طول السياق، بالإضافة إلى 100 مللي ثانية أخرى لإنهاء الجملة الأولى. تمكين الاستدلال، والذي يمتد إلى 5-10 ثواني. في البنية التقليدية، لا يمكن بدء تشغيل تحويل النص إلى كلام (TTS) حتى يقوم LLM بإنتاج نص الرد الكامل.

**تحويل النص إلى كلام** يحول نص الرد إلى كلام، ويستغرق عادةً 200-500 مللي ثانية للتوليف. إن إضافة زمن الوصول لكل مرحلة (الشكل 9-2) - VAD (500-800 مللي ثانية)، ASR (50-200 مللي ثانية)، LLM (100-500 مللي ثانية)، وTTS (200-500 مللي ثانية) - يعطي إجمالي 0.9-2 ثانية تقريبًا. وهذه هي الحالة المثالية، حيث تكون جميع الخدمات في وضع الخمول وعدم وجود قائمة انتظار.
...
>
> قامت التجربة 9-1 ببناء نظام حوار صوتي داخل المتصفح، ولكن العديد من مهام الوكيل في العالم الحقيقي تتطلب إجراء مكالمات هاتفية فعلية - الاتصال بخدمة العملاء للتفاوض بشأن الفواتير وحجز المطاعم وتأكيد الطلبات. أظهر الفصل الرابع، من خلال آلية قناة PineClaw، كيف يمكن للبنية المستندة إلى الحدث تقليل زمن الاستجابة لإشعارات الهاتف من دقائق إلى ثوانٍ. تركز هذه التجربة على بناء المكالمة الصوتية نفسها. بأخذ [PineClaw Voice API](https://pineclaw.com/) (الذي طوره فريق المؤلف) كمثال، عادةً ما تقوم واجهات برمجة التطبيقات الصوتية للاتصالات الهاتفية على مستوى الإنتاج بتغليف عملية الاتصال بأكملها، والتنقل عبر الرد الصوتي التفاعلي (على سبيل المثال، "للاستفسارات، اضغط على 1؛ وبالنسبة للمشغل، اضغط على 0" في قوائم الهاتف)، والمحادثة، والنسخ: يوفر الوكيل رقم الهاتف والهدف والسياق. المعلومات، ويكمل الوكيل الصوتي المكالمة بأكملها، ويعيد سجل المكالمات المنظم.
>
> **هدف التجربة**: بناء وكيل قادر على إكمال المهام عبر مكالمات هاتفية حقيقية، ودمج PineClaw Voice كأداة في حلقة ReAct.
>
> **المنهج الفني**: استخدم PineClaw Voice Python SDK (`pine-voice`) لتزويد العميل بأداة `make_phone_call`. يتلقى الوكيل وصف مهمة المستخدم (على سبيل المثال، "ساعدني في حجز فحص أسنان غدًا الساعة 3 مساءً")، وباستخدام منطق ReAct، يحدد: (1) رقم الهاتف الذي يجب الاتصال به؛ (2) الهدف والمعلومات الأساسية للمكالمة؛ و(3) كيفية إبلاغ المستخدم بالنتائج بعد انتهاء المكالمة.
>
> سير عمل الوكيل: يقول المستخدم "اتصل بالعيادة لحجز موعد للغد" ← يفكر الوكيل في المعلومات المطلوبة (رقم هاتف العيادة، وقت الموعد، اسم المريض) ← إذا كانت المعلومات غير كافية، يطلب التوضيح من المستخدم ← يتصل بأداة `make_phone_call` ← يتصل PineClaw بالرقم، ويتحدث مع الطرف الآخر، ويكمل الحجز ← يتلقى الوكيل ملخص المكالمة ونصها ← يبلغ المستخدم بالنتيجة.
>
> **معايير القبول**: إجراء مكالمة اختبارية بنجاح (يمكنك الاتصال أولاً بهاتفك الخاص للتحقق من الاتصال). يمكن للوكيل تحديد معلمات الاتصال بشكل مستقل بناءً على وصف المهمة. بعد انتهاء المكالمة، يقوم باستخراج المعلومات الأساسية بشكل صحيح (وقت الموعد، رقم التأكيد، وما إلى ذلك) وإبلاغ المستخدم بها. قارن الفرق بين استخدام API مباشرة والاتصال به من خلال حلقة ReAct الخاصة بالوكيل - يمكن للأخيرة التعامل مع المواقف ذات المعلومات غير الكاملة (على سبيل المثال، البحث عن رقم الهاتف إذا لم يقدمه المستخدم).
>
...
هناك مفهوم خاطئ شائع يحتاج إلى توضيح: يفترض إجمالي زمن الوصول الموضح أعلاه والذي يتراوح بين 0.9 و2 ثانية سيناريو **تسلسلي بالكامل** حيث "ينتهي كل رابط قبل تمرير العصا". إلا أن أنظمة الإنتاج في عام 2025 لم تعد تعمل بهذه الطريقة. لا يتمثل النهج السائد في التخلي عن النمطية، بل في الاحتفاظ بتقسيم VAD-ASR-LLM-TTS مع جعل كل مرحلة **بث**، مما يسمح للمراحل المتجاورة بالتداخل في الوقت المناسب:

- **يقوم ASR بالنسخ أثناء الاستماع**: باستخدام التعرف على البث، يتم إنتاج النص بشكل مستمر بينما لا يزال المستخدم يتحدث، دون انتظار VAD لتحديد نهاية الجملة قبل بدء النسخ.
- **إخراج LLM في أجزاء من الجملة**: أثناء إنشاء النموذج، يقوم بتقسيم الرد إلى جمل صغيرة بناءً على علامات الترقيم أو الدلالات. يتم إرسال الجملة الأولى في اتجاه مجرى النهر بمجرد أن تتشكل، بدلاً من انتظار كتابة الرد بأكمله.
- **تدفق تحويل النص إلى كلام (TTS) على مستوى الجملة**: يبدأ في تركيب الجملة الصغيرة الأولى وتشغيلها بمجرد وصولها، مع إنشاء الجمل اللاحقة وإضافتها بسرعة. يتحرك هذا بشكل ملحوظ حتى اللحظة التي يسمع فيها المستخدم المقطع الأول.

ونتيجة لذلك، فإن المراحل الثلاث - ASR، وLLM، وTTS - لم تعد في علاقة تسلسلية تشبه التتابع ولكنها تعمل مثل ثلاث محطات عمل على خط تجميع تعمل في وقت واحد. أطر العمل مفتوحة المصدر مثل LiveKit Agents وPipcat، بالإضافة إلى أنظمة الاتصال الصادرة التجارية السائدة، تتبع جميعها هذا النهج. بعد التدفق الكامل للسلسلة، يمكن عادة ضغط زمن الوصول من طرف إلى طرف إلى 600-800 مللي ثانية، وهو أفضل بكثير من 0.9-2 ثانية من المعالجة التسلسلية الكاملة.

لكن التدفق لا يمكن إلا أن يضغط ما يمكن أن يتداخل: النسخ، والتفكير، والتركيب. جزء واحد من زمن الوصول لا يمكنه لمسه: **صمت VAD ينتظر ويصدر الحكم نفسه**. لا يزال النظام يعتمد على عتبة صمت تبلغ 500-800 مللي ثانية لتخمين ما إذا كان المستخدم قد انتهى من التحدث، وبما أن هذا الانتظار هو الشرط المسبق للالتزام بالرد، فلا يزيله أي قدر من التداخل. إن ضغط هذا الجزء الأخير يعني تحويل الانتباه من "تداخل المراحل" إلى مرحلة الإدراك في المقدمة.

### دفق الإدراك الصوتي: استبدال VAD + ASR

تتكون الواجهة الأمامية للإدراك من مرحلتين - يحدد VAD ما إذا كان المستخدم قد انتهى من التحدث، ويقوم ASR بنسخ الصوت إلى نص. ويحددون معًا متى يبدأ خط الأنابيب بأكمله وما هي المدخلات التي يتلقاها. تواجه سلسلة VAD + ASR التقليدية ثلاث مشكلات أساسية:
...
هناك تمييز يستحق أن نحافظ عليه: تعمل وزارة التعليم على تحسين الإنتاجية - عدد الطلبات التي يمكن أن تخدمها وحدة الحوسبة. ولا يحدد بشكل مباشر متى يمكن إصدار الحزمة الصوتية الأولى؛ يعتمد زمن وصول الحزمة الأولى على بنية التوليد. يأتي زمن الاستجابة المنخفض للحزمة الأولى لـ Qwen3-Omni من وحدة Talker الخاصة بها: فهي تولد رموزًا صوتية بشكل متزايد باستخدام الانحدار التلقائي لكتب الرموز المتعددة، بينما يقوم برنامج الترميز السببي بفك تشفير تلك الرموز المميزة بشكل تدريجي إلى شكل موج. بمجرد أن تنتج وحدة التفكير نصًا، يمكن للمتحدث أن يبدأ في بث الكلام دون انتظار الاستجابة الكاملة. وفقًا للتقرير الرسمي، يبلغ زمن الوصول النظري للحزمة الأولى للبدء البارد حوالي 234 مللي ثانية. وهو يدعم الفهم بـ 19 لغة والجيل في 10، ويقود 22 من 36 معيارًا صوتيًا ومرئيًا.

**Step-Audio 2** يأخذ مسارًا مختلفًا: فهو يعالج بشكل مباشر إدخال الصوت الخام ويخرج كلاً من النص والصوت، مما يحقق محادثة صوتية حقيقية من طرف إلى طرف. فهو لا يستطيع فهم *ما* يقال* (المعلومات الدلالية) فحسب، بل يمكنه أيضًا إدراك *كيفية* ما يقال - معلومات غير لغوية، مثل ما إذا كانت مشاعر المتحدث سعيدة أم غاضبة، وما إذا كان معدل الكلام سريعًا أو مترددًا، وما إذا كان التنغيم يرتفع أم ينخفض ​​- بالإضافة إلى الأصوات والموسيقى الخلفية. فهو يولد استجابات معبرة من خلال التفكير والتعلم المعزز، ويدمج أيضًا آلية RAG والأدوات الخارجية (بحث الويب والبحث الصوتي). وفقًا لورقة Step-Audio 2، في معيار StepEval-Audio-Paralinguistic المقترح لفهم اللغة غير اللغوية، يحقق Step-Audio 2 دقة تبلغ 83.09%، متقدمًا بفارق كبير عن النموذج متعدد الوسائط المعاصر مفتوح المصدر Qwen2.5-Omni (44.18%)، ويتجاوز أيضًا GPT-4o Audio (43.45%) و كيمي أوديو (49.64%).
...
### الحل 1: التفكير السريع للحشو، والتفكير البطيء للإجابات
...
### الحل 2: التفكير السريع للتفاعل، والتفكير البطيء للحصول على المشورة
...
### الحل 3: التوحيد الشامل للتفكير والتعبير (باستخدام Step-Audio R1 كمثال)
...
في الألعاب في الوقت الفعلي، وهي واحدة من أكثر الإعدادات حساسية للتوقيت، من الممكن اتباع نهج أكثر مباشرة: الجسر الكامن[^ch9-8]. قم بتجميد كل من النموذج الصغير المسؤول عن ردود الفعل السريعة (إنتاج العشرات من الإجراءات في الثانية) والنموذج البطيء المسؤول عن التفكير (إنتاج فكرة واحدة في الثانية)، ثم قم بتدريب "جسر" صغير فقط يتكون من بضع عشرات الملايين من المعلمات بينهما. يعرض هذا الجسر استنتاجات الحالة المخفية للنموذج البطيء مباشرة في عدد قليل من "الرموز المميزة" ويدرجها في مدخلات النموذج السريع، مثلما تقوم النماذج متعددة الوسائط بإدراج الرموز المرئية. يؤدي هذا إلى تجاوز الرحلة ذهابًا وإيابًا من الفكرة إلى النص والعودة إلى التمثيل الداخلي. عبر العديد من ألعاب Atari، تتفوق قناة الفضاء الكامنة بشكل كبير على القناة النصية التقليدية (+26% إلى +82% في بعض الألعاب) مع إضافة حوالي 5 ميلي ثانية فقط لكل خطوة، وهي سريعة بما يكفي لتلبية متطلبات الوقت الفعلي.
...
>
> استخدم إمكانية استنساخ الصوت في Fish Audio S1 (يلزم فقط 3-10 ثوانٍ من الصوت المرجعي للاستنساخ بدون طلقة لنفس الجرس). أنشئ مكتبة مكونة من 24 مقطعًا صوتيًا مرجعيًا، تغطي المشاعر (محايد/سعيد/محبط/تفكير) x السرعة (عادي/سريع/بطيء) x النمط (رسمي/غير رسمي)، يبلغ طول كل منها حوالي 5 ثوانٍ.
>
> LLM
>
...
![الشكل 9-7: حلقة الإدراك والتفكير والتصرف الخاصة بعامل استخدام الكمبيوتر](images/fig9-7.svg)
...
يمكن تلخيص الاختيار من بين المسارات الثلاثة على النحو التالي: **عند توفر المعلومات المنظمة، قم بإعطاء الأولوية لفهرسة DOM/accessibility-tree** للحصول على الترجمة الأكثر دقة واستقرارًا. **عندما لا يكون متاحًا**—في برامج سطح المكتب الأصلية مثل Photoshop أو الواجهات المعروضة على قماش/WebGL أو الألعاب —**استخدم إما التعليقات التوضيحية المرئية (مسار SoM الأصلي) أو التنبؤ الإحداثي**. يعمل التعليق التوضيحي المرئي على تحويل الترجمة إلى مشكلة متعددة الاختيارات، مما يجعلها أكثر ملاءمة للنماذج ذات الأغراض العامة دون تدريب متخصص. يلغي التنبؤ الإحداثي خطوة التعليق التوضيحي ويكون أكثر مباشرة للنماذج المدربة خصيصًا على توطين واجهة المستخدم الرسومية. لا يزال كلا النهجين يواجهان صعوبة في التعامل مع العناصر الصغيرة والواجهات الكثيفة.
...
حتى الآن، يعتمد تصور استخدام الكمبيوتر على افتراض ضمني: **الشاشة ثابتة** - التقط لقطة شاشة، وسبب الخطوة التالية، ثم انقر، ثم التقط لقطة الشاشة التالية. تقوم الشاشات الحقيقية بتشغيل مقاطع الفيديو وإشعارات الفلاش التي تختفي في ثوانٍ وتشغيل الصوت من الاجتماعات. العميل الذي يفتح عينيه مرة واحدة فقط كل 3-5 ثوانٍ وليس له أذنان على الإطلاق، يكون أعمى وأصمًا تجاه كل ما يحدث بين إطارين. مشاهدة تسجيل الشاشة، والانضمام إلى اجتماع، واتباع مطالبة صوتية، والتقاط مربع حوار قبل أن يختفي - هذه الفئة الكاملة من أعمال الكمبيوتر اليومية محظورة فعليًا على وكيل استخدام الكمبيوتر اليوم.

ما يحتاج حقًا إلى إعادة تصميم هنا ليس "واجهة الإجراء"، بل "**واجهة المراقبة**"[^ch9-9]. الفكرة الأساسية هي فصل **الملاحظة** (المستمرة والتكيفية ومتعددة الوسائط) عن **الإجراء** (المنفصل)، وإنشاء طبقة برمجية وسيطة إدراكية تقع بين البيئة وأي نموذج جاهز لاستخدام الكمبيوتر دون الحاجة إلى إعادة التدريب. يمكننا أن نسمي ذلك واجهة مراقبة العميل والكمبيوتر (AOI). لديها ثلاثة مكونات "بوابة": أولاً، **التقاط الإطارات الرئيسية بين الإطارات**—استخدم بوابة بكسل رخيصة جدًا لتخطي الإطارات التي لم تتغير تقريبًا، ثم استخدم نموذجًا صغيرًا لتحديد ما إذا كان قد حدث تغيير ذو معنى، مع التقاط إطار فقط عند حدوث تغيير، مما يؤدي إلى تكلفة قريبة من الصفر للشاشات الثابتة؛ ثانيًا، **نسخ الكلام حسب مستوى الصوت** - لا يتم استدعاء التعرف على الكلام إلا عندما يكون هناك صوت، مما يمنح العميل "آذانًا" لأول مرة؛ ثالثًا، والأكثر أهمية، **تحويل الملاحظات إلى أوصاف نصية ثابتة** — اجعل النموذج يصف الإطار الملتقط في جملة واحدة (على سبيل المثال، "أفادت النافذة المنبثقة للتو أنه تم تغيير تاريخ الإصدار إلى 28 أبريل")، و **حتى إذا تم مسح الصورة الأصلية لاحقًا من السياق، فسيظل هذا النص في الذاكرة**، حاملاً المعلومات الديناميكية إلى الأمام في شكل نصي.

النتيجة غير البديهية هي أن ما يهم حقًا ليس اختيار الإطار ولكن تحويل الإطارات المحددة إلى نص ثابت، لأن النص هو الطريقة الأفضل التي يتعامل معها وكلاء LLM. عبر ثمانية نماذج، بدءًا من نماذج المعلمات 7B إلى الأنظمة ذات النطاق الحدودي، حققت هذه البرامج الوسيطة مكاسب تتراوح بين +17 إلى +48 نقطة مئوية دون أي إعادة تدريب، مع وجود فجوة واسعة في المهام الصوتية: مع وجود الطبقة الإدراكية في مكانها، تمكن الوكيل أخيرًا من إكمال المهام الصوتية التي كانت "مسموعة ولكنها غير قابلة للتنفيذ". ومع ذلك، فهو ليس تكوينًا واحدًا يناسب الجميع - في بعض الطرز الأحدث، يؤدي إدخال عدد كبير جدًا من الرموز المميزة للصور إلى مزاحمة المنطق وسحب الأداء إلى الأسفل. لذا، يجب اختيار المكونات حسب الطراز**، وليس تشغيلها بالجملة. إنه نفس الدرس المستفاد من مقايضة التنبؤ بمجموعة العلامات مقابل الإحداثيات: لا يوجد حل سحري في مخططات الإدراك؛ يمكنك تكوينها لتناسب مزاج النموذج.
...
### الأداء في الوقت الحقيقي: التحدي الأساسي الذي لم يتم حله
...
## التلاعب بالروبوت: من التحكم في الوقت الحقيقي إلى التدريب والتعميم
...
>
> باستخدام جهاز محاكاة LeRobot + ManiSkill، تدرب باستخدام صور كاميرا RGB فقط (دون الاعتماد على مستشعرات العمق أو مستشعرات القوة)، ثم قم بنشر اللقطة الصفرية (دون أي ضبط إضافي) مباشرةً على ذراع روبوتية SO100 حقيقية. تتكون العملية من خمس خطوات:
>
...
على السطح، لا يمكن أن تختلف السيناريوهات الثلاثة أكثر من ذلك، إلا أن العقبة المزدوجة المتمثلة في الكمون وتعدد الوسائط تظليلها جميعًا. لقد تطور الوكلاء الصوتيون من خطوط الأنابيب التسلسلية إلى الأنظمة الشاملة والثنائية الكاملة، ومن التفكير المنفصل السريع والبطيء إلى التفكير أثناء التحدث. يقترب استخدام الكمبيوتر الآن من الدقة البشرية في معايير مثل OSWorld، ولكنه يتطلب خطوات أكثر بكثير من الإنسان، وتستغرق كل خطوة وقتًا أطول مع تقدم المهمة - وهي فجوة في الكفاءة لا يوجد حل منهجي حتى الآن. بالنسبة للروبوتات التي تؤدي مهام معالجة موجهة بصريًا، انتقل عنق الزجاجة من الأجهزة إلى قدرة طبقة التحكم VLA على التعميم عبر المهام (يظل الاستشعار عن طريق اللمس والأيدي الماهرة من قيود الأجهزة التي لم يتم حلها). ينتقل الفصل التالي إلى التعاون بين العديد من الوكلاء، وهو تحدٍ ذو بُعد مختلف.
