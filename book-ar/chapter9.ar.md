...
#### الحل الأول: تفكير سريع يجامل، وتفكير بطيء يجيب

يستطيع التفكير السريع أن يقدم ردًا مؤقتًا خلال مئات قليلة من الميلي ثانية، بينما يكمل التفكير البطيء استدلالًا أعمق في الخلفية. المشكلة أن الأسئلة البسيطة تُعالج مرتين، وأن الأسئلة المعقدة قد تنتهي إلى تناقض: يقترح النموذج السريع شراء الباقة، ثم يكتشف النموذج البطيء أنها تفتقر إلى ميزة أساسية، فيسمع المستخدم إجابتين متعارضتين خلال ثوانٍ. السبب الجذري أن نسختين فكّرتا كلٌّ على حدة.

![الشكل 9-5: مقارنة بنى التفكير السريع والبطيء](images/fig9-5.svg)

#### الحل الثاني: تفكير سريع يتفاعل، وتفكير بطيء يذكّر

هنا يقدم نموذج الخلفية اقتراحات إلى النموذج الأمامي عبر شريط حالة أو واجهة مخصصة، ويظل النموذج الأمامي ممسكًا بالحوار ومقرّرًا كيفية الصياغة. هذا أكثر استقرارًا من الحل الأول، لكن الاتصال يبقى غير مباشر: قد يسيء النموذج الأمامي فهم الاقتراح، وهو لا يرى الاستدلال الوسيط في الخلفية. وقبل أن تنتهي الخلفية، لا يملك النموذج الأمامي سوى قدراته الذاتية للرد على سؤال إضافي. يمكنه أن «ينتظر النتيجة» بشكل طبيعي، لكنه لا يفكر فعليًا أثناء الكلام.

#### الحل الثالث: توحيد التفكير والتعبير من طرف إلى طرف (مثال Step-Audio R1)

يضع الحل الثالث القدرة على التفكير داخل نموذج الصوت الطرفي نفسه. يعالج Step-Audio R1 مشكلتين بآليتين متكاملتين: **تقطير الاستدلال المرتكز على الوسيط (MGRD)** يجعل النموذج يفكر انطلاقًا من السمات الصوتية، و**بنية الدماغين MPS** تجعل التصور والتعبير يجريان بالتوازي. الأولى تضمن «صحة التفكير»، والثانية تضمن «الكلام في وقته».

في الحالة المثالية ينبغي أن يحكم النموذج على المشاعر من طبقة الصوت والإيقاع والتنغيم، لا من النص المفرَّغ وحده. وما يسمى «التفكير عبر وكيل نصي» هو أن يستبدل النموذج تحليل اللحن والسمات الصوتية بالكلمات السلبية في كلمات الأغنية. تنتقي MGRD مسارات التفكير التي تستشهد فعلًا بالسمات الصوتية، وتدرّب النموذج على هذه البيانات، وتمنعه عبر التعلم المعزز من تخطي التفكير وتخمين الإجابة مباشرة.

تجعل MPS دماغ التصور ينتج شذرات تفكير باستمرار، بينما يحوّل دماغ التعبير كل شذرة إلى كلام فورًا بدمجها مع ما قيل. يعمل الاثنان بالتوازي على هيئة خط أنابيب، فلا ينتظر المستخدم انتهاء التفكير كاملًا ليسمع الجملة الأولى (الشكل 9-6).

![الشكل 9-6: بنية الدماغين MGRD وMPS في Step-Audio R1](images/fig9-6.svg)

النموذج الموحّد هو الأقرب إلى «التفكير أثناء الكلام»، وثمنه أن التفكير والتعبير الآني يحتاجان إلى إعادة تدريب معًا. المسار المفكوك يسهّل استبدال دماغ الخلفية، والمسار الموحّد أنسب للسيناريوهات المتخصصة التي تطلب أقصى درجات الطبيعية. هما مفاضلة لا إحلال بسيط.
...
في طبقة التنفيذ للبنية المكونة من طبقتين، تركز ثلاثة نماذج تمثيلية — RT-2، وOpenVLA، وπ₀ — على التحكم في VLA، أي إخراج إجراءات الروبوت في الوقت الفعلي استنادًا إلى صور الكاميرا وتعليمات اللغة. إنهم يتبعون طريقتين مختلفتين لتمثيل العمل: رموز العمل المنفصلة وتوليد المسار المستمر.
