...
> **التجربة 9-4 ★★★ `[تصميم فقط]`: إنشاء مسارات عمل يمكن التحقق منها من مسارات المتصفح**
>
...
> **التجربة 9-8 ★★ `[مستودع خارجي]`: بوابة تأكيد للعمليات عالية المخاطر تُحدّثها ملاحظات المستخدم**
>
