...
كل ما نوقش حتى الآن كان من زاوية هندسية: كيف نجعل مجموعة من الوكلاء تنجز مهمة معًا. أما القسم التالي فـ**يختلف في جنسه عن سائر الكتاب**: فالفصول التسعة والنصف السابقة تجيب عن «كيف نبني»، وهذا القسم يجيب عن «ما الذي يُجرَّب الآن» — فهو مسح لتجارب المجتمعات متعددة الوكلاء الجارية، يقدّم ملاحظات وأسئلة مفتوحة لا وصفة هندسية تُتَّبع مباشرة. وإنما بقي في هذا الفصل لأن هذه التجارب تدفع بما نوقش أعلاه — مشاركة السياق، وطوبولوجيا التعاون، وأنماط الإخفاق — إلى مقياس أقصى، ولأن اثنتين منها (بلدة ستانفورد للذكاء الاصطناعي، ولعبة المستذئب الصوتية) يوفّر لهما هذا الكتاب مشروعين مرافقين قابلين لإعادة الإنتاج وللتشغيل. اقرأ هذا القسم بوصفه اختبار إجهاد للاستنتاجات الهندسية السابقة على مقياس زمني أطول بكثير.
...
وهذا الفصل هو كذلك آخر فصول المتن. فمن صيغة الفصل الأول Agent = LLM + السياق + الأدوات، مرورًا بالبناء والتقييم والتطوّر، وصولًا إلى التعاون في هذا الفصل، اكتمل المسار الهندسي. لكن يبقى سؤالان لا تستطيع الهندسة وحدها الإجابة عنهما: كم سيبقى من Harness اليوم مع استمرار قوة النماذج في الازدياد؛ وهل يمكن سدّ المعرفة الخاصة بمستخدم بعينه أو شركة بعينها بمجرد «تدريب مرة أخرى». والخاتمة تتولّى كليهما.
