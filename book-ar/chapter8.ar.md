...
>
> **التحدي:** بدل مسألة مصطنعة، أعطينا Hermes الكتاب كاملًا مع شفرته: «اقرأ، ثم انظر إلى نفسك ونفّذ تحسينًا حقيقيًا». قدّم قارئ أربع إشارات — تجارب الاستئصال، وشريط الحالة، ونسيان الذاكرة، وآلية Reviewer — لكن كان على Hermes قراءة الفصول وتحديد ما يناسب تصميمه.
>
> **لم يكتفِ بقائمة اقتراحات:** بعد قراءة الفصول العشرة، قارن Hermes أفكار الكتاب ببنيته واختار تحسينًا عمليًا أولًا: جعل حالة عمله الحالية مرئية للنموذج. ثم عدّل شفرته بنفسه وشغّل التحقق.
>
> **كل رفض صار درسًا جديدًا:** فحص Reviewer جديد التعديل. وعندما رفضه، عادت الملاحظات إلى Hermes الأصلي، فقرأ الشفرة من جديد وأصلح المشكلة وحاول مرة أخرى، حتى قُبل التغيير. باختصار: **اقرأ ← قارن ← غيّر ← راجع ← تعلّم ← غيّر من جديد**.
>
> **لماذا هذا ممتع؟** يمكن للكتاب أن يصبح دليل ترقية للـAgent. أثبت Hermes أنه يفهم المبادئ ويربطها بتنفيذه ويكمل تعديلًا فعليًا من خلال الملاحظات. أما تحسن كل المهام اللاحقة فيحتاج إلى تجربة استئصال منفصلة. السجل الكامل في [`hermes-self-evolution`](../chapter8/hermes-self-evolution/).
