...
النجوم في عنوان التجربة تعبّر عن **الصعوبة**، لا عن **كلفة التشغيل**. والأصل أن تأتي التجربة بشيفرة قابلة للتشغيل داخل هذا المستودع، فتعمل بمجرد ضبط بيانات الاعتماد؛ أما الاستثناءات الثلاثة فتُوسَم في العنوان: `[مستودع خارجي]` يعني أن عليك استنساخ مستودع خارجي بنفسك، كإطار تدريب أو معيار مرجعي؛ و`[تصميم فقط]` يعني أن المتن يعطي البنية ومعايير القبول فحسب، وكتابة الشيفرة القابلة للتشغيل متروكة للقارئ؛ و`[عتاد حقيقي]` يعني أن التنفيذ يقتضي ذراعًا آليةً فعليةً أو جهازًا مماثلًا. ويحوي ملف README المرافق لكل فصل جدولًا بأنواع المشاريع لكل تجربة وقائمةً بالاعتماديات الخارجية.
