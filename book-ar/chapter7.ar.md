...
توضح نماذج مثل Kimi K3، التي تم تحسينها لاستخدام الأدوات والتفكير طويل السلسلة، الاتجاه النموذجي لنموذج LLM+RL: يوفر التدريب المسبق على اللغة على نطاق واسع الأساس، ويعزز التدريب اللاحق تحليل المشكلات واستخدام الأدوات والتصحيح الذاتي. **OpenVLA[^ch7-21]** (المفصل في الفصل 9) يعرض نموذج هندسة VLA (الرؤية واللغة والعمل) لعصر LLM: يقوم جهاز تشفير الرؤية بمعالجة الملاحظات البيئية، ويفهم نموذج اللغة التعليمات والأسباب، ويولد جهاز فك تشفير الإجراء إشارات تحكم، مما يتيح التحكم المشروط باللغة والتعميم عبر المهام. للتوضيح، تم تدريب OpenVLA نفسه من خلال التعلم بالتقليد على ما يقرب من مليون روبوت **مسارات العرض**، مما يجعله SFT في الطبيعة بدلاً من RL. يعد SimpleVLA-RL، الذي تم تقديمه في التجربة 7-13 لاحقًا في هذا الفصل، مثالًا تمثيليًا لجلب RL إلى الروبوتات باستخدام المكافآت لتحسين هذا النوع من بنية VLA بشكل أكبر.
...
تشترك هذه التجارب الأربع في سمة مشتركة - "كتابة تعيينات وبروتوكولات مستقرة إلى معلمات": يعمل الصوت SFT على ترسيخ بروتوكولات التحكم في الأسلوب، ويعمل SFT متعدد اللغات على ترسيخ قوالب تنظيم التفكير، ويعمل التقطير SFT على ترسيخ التعيين المباشر من الإدخال إلى الإخراج. وهي تشترك في أهداف واضحة وتنسيقات نظيفة ومعايير تقييم مستقرة، مما يسمح لـ SFT بتحقيق مكاسب بكفاءة عينة عالية للغاية؛ ومع ذلك، بمجرد أن يتغير التوزيع، فإن ميله نحو الحفظ يتجلى في أداء متدهور. هذا هو المظهر التجريبي لتقسيم تعميم الذاكرة الذي تمت مناقشته في القسم [7.1](#التدريب-المسبق-sft-rl-بانوراما-ثلاثية-المراحل)، "الفرق الأساسي بين SFT وRL".

يمكن تحويل حالات bad case في الفصل السادس إلى بيانات تدريب. في حالة وكيل برمجي ينهي المهمة مبكرًا، نقتطع بادئة المسار قبل إعلان الاكتمال، ونجعل الإعلان الأصلي rejected، بينما يكون «شغّل الاختبارات، وافحص شروط القبول واحدًا واحدًا، ثم استنتج» هو chosen. هذا أنسب لـ DPO أو لعرض حدّ القرار من SFT العادي. يجب حفظ سبب الفشل وشروط التطبيق وأداة التحقق مع كل عينة؛ ويوفر `build_preference_data.py` مسارًا حتميًا ومسارًا بنموذج معلّم مع فصل بيانات التدريب عن التقييم.
...
يوضح القسم [7.1](#التدريب-المسبق-sft-rl-بانوراما-ثلاثية-المراحل) **الفرق الأساسي** بين SFT وRL. يجيب هذا القسم على سؤال أكثر عملية: **نظرًا لمهمة محددة، أي مهمة يجب أن تستخدمها؟** سيتم التحقق من صحة بعض الاستنتاجات من إطار القرار أدناه بشكل أكبر في تجارب RL اللاحقة (التجربة 7-10، التجربة 7-11). يمكن للقراء أولاً تكوين حكم أولي ثم العودة إلى الإسناد الترافقي بعد قراءة قسم RL.
...
**(3) لماذا تم تصميمه بهذه الطريقة؟ — أصل البحث عن الوضع.** يتميز Reverse KL بخاصية أساسية: إنه **البحث عن الوضع**. وضع القسم [7.1](#التدريب-المسبق-sft-rl-بانوراما-ثلاثية-المراحل) الأساس لهذا — يسمح KL العكسي للنموذج **بالاحتفاظ فقط بعدد قليل من "الأوضاع" ذات المكافأة العالية وتجاهل الباقي بشكل حاسم**، دون الاضطرار إلى تغطية كل شيء بالتساوي مثل أقصى احتمالية لـ SFT (التغطية الجماعية). في سياق RLHF، هذا هو بالضبط التأثير الذي نريده: حدد واحدًا أو اثنين من أنماط الاستجابة عالية الدرجات التي يتعرف عليها RM وقم بإنتاجها باستمرار، بدلاً من تعلم كل استجابة ممكنة. وهذا ما يفسر أيضًا سبب ظهور النماذج بعد RL أكثر "حسمًا" وأقل تنوعًا. معًا، يعد سلوك البحث عن الوضع العكسي لـ KL وقدرته على إبقاء النموذج بالقرب من التوزيع المرجعي هو المفتاح لاستقرار RLHF.
...
> **التجربة 7-16 ★★★: RLVP — كافئ النتيجة، وعاقب المسار `[Extended Experiment]`**
>
...
> **التجربة 7-14 ★★★: ReTool — مترجم الأكواد المحسّن لحل المشكلات الرياضية**
>
>
...
> **التجربة 7-15 ★★★: القطار العالمي - تعلم استخدام الأدوات في وضع الحماية**
>
>
...
نعود هنا إلى سؤال الفصل السادس: كيف تتحول بيانات التقييم المبنية من حالات الفشل في الإنتاج إلى مدخلات للتدريب اللاحق؟ فسجلات إسناد الفشل، واختبارات الانحدار من البداية إلى النهاية، واختبارات بادئة المسار، ودرجات Rubric، لها استخدامات تدريبية مختلفة.

الجدول 7-4. ربط بيانات تقييم الفصل السادس باستخدامات التدريب في الفصل السابع

| بيانات تقييم الفصل السادس | استخدامها في تدريب الفصل السابع |
|---|---|
...
> **التجربة 7-17 ★★: من حالات «الإكمال المبكر» إلى DPO**
>
...
> **التجربة 7-18 ★★: تدريب SFT لعلامات الاقتباس المنحنية الحساسة للنطاق**
>
...
> **التجربة 7-19 ★★: SFT للنسخ الدقيق للسلاسل الخاصة**
>
