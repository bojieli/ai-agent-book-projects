...
من الناحية التنفيذية تنقسم خوارزميات RL إلى **أساليب استكشاف عبر الإنترنت**، تتعلم من تفاعل جديد مع البيئة، و**أساليب تحسين دون اتصال**، تتعلم من بيانات موجودة سلفًا وتكون عادةً أبسط وأكثر استقرارًا. وهنا يلزم ضبط مصطلحين: تحدّث **الأساليب المتوافقة مع السياسة (On-Policy)** السياسة باستخدام بيانات أخذتها السياسة الحالية نفسها حديثًا، بينما تستطيع **الأساليب غير المتوافقة مع السياسة (Off-Policy)** التعلم أيضًا من بيانات أنتجتها سياسات أخرى أو إصدارات أقدم، كما في Q-learning. ووفق هذا التعريف، فإن SFT تقليد غير متوافق مع السياسة لأن بياناته تأتي من معلم أو عروض بشرية. أما التطبيقات المعتادة لـ PPO وGRPO في تدريب النماذج اللغوية فهي متوافقة مع السياسة؛ إذ تولّد كل جولة مسارات جديدة بالنموذج الحالي ثم تستخدمها في التحديث. وأما DPO فهو تحسين تفضيلات دون اتصال، فلا يتطلب أخذ عينات عبر الإنترنت ولا يحقق بالضرورة شرط التوافق الصارم مع السياسة.
