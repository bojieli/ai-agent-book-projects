...
الصيغة الأساسية لهذا الكتاب هي Agent = LLM + سياق + أدوات. يتحول هذا الفصل إلى LLM نفسه - "العقل" - ويفحص كيف يمكن للتدريب اللاحق أن يساعد النموذج على استخدام السياق والأدوات بشكل أكثر فعالية، وبالتالي تحسين قدرات نظام الوكيل بأكمله. وتشير نهاية الفصل السادس إلى أن نظام التقييم وبيئة المحاكاة هما حجر الزاوية في مرحلة ما بعد التدريب: بيئة التقييم تعطي التدريب أرضية ممارساته، ومقاييس التقييم تعطيه هدفه. يعتمد هذا الفصل على هذه الركائز الأساسية ويناقش كيفية تغيير أوزان النماذج فعليًا - كيفية دمج القدرة في المعلمات.

لا يفترض هذا الفصل أي خلفية في التعلم المعزز أو التدريب النموذجي. لا نتوقع منك أن تعرف التدرجات أو تحسين السياسة. بدلًا من ذلك، نبدأ من السؤال حول كيفية تدريب النموذج على الإطلاق، مع توضيح الغرض من كل خطوة، وكيف تعمل، وما هي المشكلة التي تحلها. بحلول نهاية الفصل، يجب أن تكون قادرًا على الإجابة على الأسئلة التالية: ما عدد المراحل التي تتضمنها صياغة قدرات النموذج؟ ماذا تفعل كل مرحلة؟ لماذا يجب أن تحدث بهذا الترتيب؟ وأين يجب أن تركز جهدك في مشاريعك الخاصة؟

**أولاً، لنضع الخريطة الأهم: قدرات النموذج الحديث تتم صياغتها على ثلاث مراحل.** هذه المراحل الثلاث متشابكة ولا غنى عنها:

1.  **التدريب المسبق**: تدريب على نص ضخم عبر الإنترنت "للتنبؤ بالرمز المميز التالي." تعلمك هذه الخطوة قواعد اللغة النموذجية والمعرفة العالمية والتفكير الأساسي. إنه مثل شخص قرأ جميع الكتب الموجودة في المكتبة، فهو واسع المعرفة، لكنه ليس جيدًا بعد في الإجابة على الأسئلة. هذه هي الخطوة الأكثر تكلفة (في كثير من الأحيان عشرات الملايين من الدولارات) وأساس كل القدرات.
2.  **الضبط الدقيق الخاضع للإشراف (SFT)**: تدريب النموذج على أزواج المدخلات والمخرجات المصنفة، تمامًا مثل قيام المعلم بإعطاء الطالب إجابات قياسية لتقليدها. الآلاف إلى عشرات الآلاف من العروض التوضيحية للأسئلة والأجوبة القياسية تعلم النموذج التنسيق والأسلوب والعملية التي يجب استخدامها عند الاستجابة. تعمل هذه الخطوة على تحويل النموذج واسع المعرفة إلى مساعد يفهم التعليمات وينتج مخرجات جيدة التنظيم. إنها رخيصة الثمن وسريعة ومستقرة، وهي حاليًا خطوة تمر بها جميع النماذج المنشورة تقريبًا.
3.  **التعلم المعزز (RL)**: السماح للنموذج بالمحاولة بشكل متكرر والتحسين من خلال المكافآت والعقوبات، مثل تدريب جرو (مكافأة عندما يقوم بالأمور بشكل صحيح، ولا شيء عندما لا يكون كذلك). بدلاً من إظهار الإجابات القياسية للنموذج، يتيح RL له المحاولة بمفرده، مما يزيد من احتمالية السلوك الجيد ويقلل من احتمالية السلوك السيئ. تعلم هذه الخطوة النموذج كيفية اتخاذ قرارات معقولة حتى في **المواقف غير المرئية**—وهي أيضًا الخطوة التي تشغل المساحة الأكبر في هذا الفصل وتتطلب أكبر قدر من الجهد الهندسي.

تشبيه بديهي: التدريب المسبق هو "قراءة عشرة آلاف كتاب" (تراكم المعرفة)، وSFT هو "معلم يرشدك عبر الحلول القياسية" (تقليد العروض التوضيحية)، وRL هو "حل المشكلات بنفسك والتنقيح من الصواب والخطأ" (التعلم عن طريق التجربة والخطأ). الثلاثة ليسوا بدائل. إنهم يشكلون خط أنابيب – اقرأ أولاً، ثم شاهد العروض التوضيحية، ثم تدرب.

**يحتوي هذا الفصل على موضوعين رئيسيين يتم تشغيلهما طوال الوقت. يرجى تذكرها، حيث أن كل المحتوى اللاحق يخدمها:**

*   **الموضوع الأول: SFT يحفظ، RL يعمم.** بالنسبة لنفس المهمة والميزانية، يميل SFT إلى **حفظ** الإجابات في بيانات التدريب، ويفشل عندما تختلف بيئة النشر عن التدريب. يميل RL إلى **تعلم** استراتيجية قابلة للتحويل، ويظل مستقرًا حتى في المواقف غير المرئية. وهذا ليس مجرد شعار، بل هو ظاهرة قابلة للقياس سيتحقق منها هذا الفصل مرارًا وتكرارًا من خلال التجارب الخاضعة للرقابة. سيخصص القسم 7.1 قسمًا كاملاً لشرح **الأسباب الأساسية** لهذا الاختلاف.
*   **الموضوع الثاني: أهمية البيانات والبيئة أكثر من الخوارزميات.** هذا هو الدرس الأكثر قيمة وتناقضًا في الصناعة. مع خوارزميات RL الجاهزة (PPO، GRPO، وما شابه)، فإن معرفة كيفية استخدامها تكفي. هناك أمران يحددان النجاح فعليًا: **بيئة المحاكاة** (هل أرض التدريب واقعية بدرجة كافية؟) و**بيانات التدريب** (هل العروض التوضيحية وإشارات المكافأة جيدة بما يكفي؟). في العديد من السيناريوهات، إذا كانت بيانات SFT جيدة بما فيه الكفاية، فقد لا تحتاج إلى RL على الإطلاق. سيعيد هذا الفصل توجيه انتباهك بشكل متكرر من "ما هي الخوارزمية التي يجب أن أقوم بضبطها؟" إلى "هل تم إعداد البيانات والبيئة بشكل صحيح؟"

> **دليل القراءة**: ينقسم محتوى هذا الفصل إلى مسارين بناءً على خلفية القارئ:
>
> *   **مطورو تطبيقات الوكلاء** (لا يحتاجون إلى تدريب النماذج بأنفسهم): ابدأ بقراءة الافتتاحية "التدريب المسبق، SFT، RL: A Three-Stage Panorama" لبناء فهم عالمي. ثم يمكنك تخطي قسمي `[Optional Reading]` التاليين (RL الكلاسيكي وخلفية ما قبل التدريب) والمتابعة من قسم SFT. ركز على إطار القرار الخاص بـ "الفرق الأساسي بين SFT وRL" و"متى تختار SFT مقابل SFT". RL"، بالإضافة إلى الحكم بأن "البيانات والبيئة أكثر أهمية من الخوارزميات" - ستؤثر هذه الأفكار على قرارات التصميم الخاصة بك في هندسة Harness (متى يجب الحل باستخدام المطالبات، وعندما يكون الضبط الدقيق يستحق ذلك).
> *   **نموذج تدريب المهندسين**: اقرأ بشكل تسلسلي من البداية. يوفر القسمان `[Optional Reading]` خلفية كاملة عن التعلم المعزز والتدريب المسبق. التجارب اللاحقة توفر خطط التدريب استنساخه.
...
- **إشارة المكافأة**: ردود الفعل الفورية من البيئة. ومع ذلك، فإن هدف الوكيل هو تعظيم المكافأة على المدى الطويل، وليس الفوري - وهذا التمييز أمر بالغ الأهمية، تمامًا كما لا ينبغي الحكم على الاستثمار من خلال مكاسب وخسائر اليوم ولكن من خلال العائدات طويلة الأجل.
- **وظيفة القيمة**: تقدير إجمالي المكافأة التراكمية التي يمكن الحصول عليها من حالة معينة في المستقبل، مما يساعد العميل على اتخاذ قرارات حكيمة حتى بدون الحصول على تعليقات فورية. أحد أهم الأفكار المستفادة من ستين عامًا من أبحاث RL هو الدور المركزي لتقدير القيمة.
...
|---------------|------------------------|-------------------------------|-------------------------|
| **غزال الوليد** | التضاريس والجاذبية ووضعية الجسم | استمرار عالي الأبعاد (تقلصات مجموعة العضلات) | التوازن (+)، الهبوط (-) |
...
يختلف النموذجان بشكل أساسي في مساحة الفعل - يفترض MDP أن مساحة الحركة محدودة ومغلقة (أعلى/أسفل/اختيار/مكان)، في حين أن مساحة العمل في LLM مفتوحة النهاية، وتتكون من تسلسلات لغة طبيعية متفجرة بشكل اندماجي. ينتج عن هذا الاختلاف انقسامًا أساسيًا بين النموذجين في تصميم الخوارزمية وكفاءة العينة والتعميم. وتناقش كل نموذج أدناه.
...
إن كتابة هذا الحدس كمعادلة يعطي العلاقة التكرارية الأساسية لمعادلة بيلمان الشهيرة ** في الكتب المدرسية RL: **القيمة الحقيقية للإجراء = المكافأة الفورية التي تم الحصول عليها في هذه الخطوة + الحد الأقصى للقيمة المستقبلية التي يمكن الحصول عليها من الحالة التالية**:

$$Q^*(s, a) = r + \gamma \max_{a'} Q^*(s', a')$$

حيث $r$ هي المكافأة الفورية، $s'$ هي الحالة التالية التي تم الوصول إليها بعد تنفيذ الإجراء (مكتوبة في شكل حتمي للحدس؛ في بيئة عشوائية، هناك حاجة إلى توقع على الحالة التالية $s'$)، و$\gamma \in [0, 1)$ هو **عامل الخصم** - فهو يحدد مقدار تقدير الوكيل للمستقبل: كلما اقتربنا $\gamma$ يساوي 1، كلما زادت قيمة العوائد طويلة الأجل؛ كلما اقتربت من 0، كلما زاد تركيزها على الفوري. "المكافأة التراكمية" المذكورة مرارًا وتكرارًا سابقًا هي بالضبط مجموع المكافآت في كل خطوة، مخصومًا منها بواسطة $\gamma$: $\sum_{t} \gamma^{t} r_t$. بعد كل إجراء، تقوم الخوارزمية بتعديل التقدير القديم قليلاً نحو "النتيجة التي تمت ملاحظتها فعليًا" - يُسمى هذا النموذج المتمثل في "تصحيح التقدير القديم بنتيجة فعلية من خطوة واحدة" **التعلم بالفرق الزمني (تعلم TD)**. وبعد آلاف المحاولات، يقترب التقدير تدريجيًا من القيمة الحقيقية.
...
>
> للتحقق من خصائص وحدود Q-learning، قمنا بتصميم **بيئة لعبة البحث عن الكنز**. تشتمل هذه البيئة على العديد من التحديات الرئيسية: **الآليات المخفية** التي تتطلب من العميل اكتشاف المراسلات بين المفاتيح والأبواب وتأثيرات الأسلحة وقواعد تصنيع العناصر بنفسه؛ **التبعيات متعددة الخطوات** تعني أن إكمال المهمة يتطلب التسلسل الصحيح للإجراءات (الحل الأمثل: 11 خطوة)؛ **المكافآت المتفرقة** تعني أن الإجراءات الرئيسية والنصر النهائي فقط هي التي تنتج مكافآت كبيرة، مع عدم تلقي معظم الخطوات المتوسطة أي تعليقات.
>
...
> - **أول 1000 حلقة**: معدل الفوز 0%، Q-table بها 124 ولاية فقط، العميل يستكشف بشكل أعمى
...
في RL التقليدي، لا يمكن للوكيل تلقي التعليقات إلا من خلال تغيير البيئة: القيام بخطوة في الشطرنج، أو اتخاذ خطوة في المتاهة. لكن نماذج LLM يقدم نوعًا جديدًا تمامًا من العمل: التفكير الداخلي. التفكير لا يغير العالم الخارجي، لكنه يمكن أن يحسن بشكل كبير جودة الإجراء النهائي. يغير هذا التحول كل شيء: لم تعد مساحة عمل العميل مجرد "ما يجب فعله"، ولكنها تتضمن أيضًا "كم من الوقت يجب التفكير فيه وما يجب التفكير فيه".
...
![الشكل 7-5: مقارنة بين RL الكلاسيكي وعامل LLM الحديث](images/fig7-5.svg)

هذه القدرة على التفكير، المرتكزة على القواعد المتأصلة في اللغة، تمكن عملاء LLM من فهم التعليمات التي لم يروها من قبل (تعميم مطلق النار) وإتقان المهام الجديدة بأمثلة قليلة جدًا (تكيف محدود اللقطات) - وهو تناقض صارخ مع نموذج وكيل MDP التقليدي الذي يتطلب تجربة وخطأ مكثفين. علاوة على ذلك، يدعم النموذج الجديد أيضًا التعميم التركيبي (إعادة الجمع بين المفاهيم المعروفة للتعامل مع المواقف الجديدة)، والتعلم في السياق (التكيف السريع من خلال المحفزات والأمثلة)، والفهم المتعدد الوسائط (دمج الوسائط بشكل طبيعي مثل الرؤية، واللغة، والعمل). لاحظ أن **فعالية** التعلم في السياق (التعميم الصفري، والتكيف القليل) و**آليتها الداخلية** هما شيئان مختلفان - كما تم تحليلها في الفصل الثاني، تعمل آلية الانتباه بشكل أقرب إلى الاسترجاع منها إلى التفكير، ولكن هذا لا يعيق تأثيراتها العملية القوية في التكيف مع المهام.

يعكس التطور من مساحة العمل المغلقة إلى مساحة العمل المفتوحة تحولًا أساسيًا في نموذج عميل الذكاء الاصطناعي. وبعيدًا عن التفكير الداخلي، فإن تنوع معلمات الأداة (استعلامات اللغة الطبيعية، رمز البرنامج، JSON المعقد، المحتوى متعدد الوسائط) يجعل مساحة العمل الفعلية لا نهائية تقريبًا - يمكن لمترجم التعليمات البرمجية تنفيذ أي مهمة قابلة للحساب نظريًا، ويمكن لأداة البحث استكشاف مساحة المعلومات الكاملة للإنترنت. وهذا يجلب فرصًا جديدة (يمكن للوكلاء التعامل مع مهام غير مسبوقة، وحل المشكلات المعقدة من خلال الجمع بين الأدوات الأساسية) وتحديات جديدة (كيفية تحديد وظائف المكافأة وتحسينها في بيئة مفتوحة، وكيفية البحث بكفاءة في مساحة عمل لا نهائية).
...
>
>
> ![الشكل 7-7: مقارنة البنية بين Q-learning وعامل LLM في لعبة البحث عن الكنز](images/fig7-7.svg)
>
>
> لقد قارنا Q-learning مع وكيل LLM — Kimi K3، مع الاحتفاظ بمخزن مؤقت يصل إلى 50 تجربة — في نفس لعبة البحث عن الكنز. النتائج مذهلة: **أكمل عميل LLM اللعبة في 18 خطوة في محاولته الأولى**.
>
...
## أساسيات ما قبل التدريب للنموذج `[Optional Reading]`
...
>
> **التجربة 7-8 ★★: التقطير السريع — تكرار القدرات القابلة للاستخدام بتكلفة أقل**
>
> في التطبيقات العملية، لجعل النموذج يؤدي مهام معقدة، غالبًا ما تكون مطالبات النظام الطويلة (الآلاف أو حتى عشرات الآلاف من الرموز المميزة) مطلوبة، مما يؤدي إلى زيادة زمن الوصول والتكلفة مع كل مكالمة. عند استخدام المنطق نماذج LLM، تعمل رموز التفكير الداخلي على زيادة التكلفة. الفكرة وراء التقطير السريع هي ضغط سلوك "المدرس الطويل + المعلم المفكر" إلى "الحث القصير/بدون موجه + الطالب غير المفكر". يقوم المعلم بإنشاء إجابات عالية الجودة في ظل وضع التفكير السريع الكامل؛ تحتفظ بيانات التدريب فقط بمدخلات المستخدم والاستنتاج النهائي، متجاهلة عملية التفكير السريعة والوسيطة الطويلة. يتعلم الطالب "إعطاء الاستنتاج مباشرة". بعد التقطير، تقترب جودة مخرجات الطالب على نفس المدخلات من جودة المعلم، في حين يتم تقليل زمن الوصول والتكلفة بشكل كبير لأنه ليست هناك حاجة لمعالجة المطالبات الطويلة ورموز التفكير المميزة.
>
> يمكن تنفيذ عملية التقطير على طول بعدين: "الكبير إلى الصغير" (استبدال النموذج الكبير بنموذج متوسط أو صغير لموازنة التكلفة والجودة) و"التفكير مقابل عدم التفكير" (تحويل CoT الصريح إلى معرفة بارامترية ضمنية على نفس المقياس، مما يؤدي إلى تحسين سرعة الاستجابة بمقدار 20-30x). لا يستبعد هذان الأمران بعضهما البعض، وغالبًا ما يتم استخدامهما معًا في بيئات الإنتاج. من المهم ملاحظة أن التقطير يرث حدود المعلم - إذا كان لدى المعلم أخطاء منهجية في ذيل التوزيع الطويل، فسيقوم الطالب بترميز هذه الأخطاء بشكل أكبر؛ إذا اعتمد المعلم على الأدوات للتأكد من صحتها، فإن التقطير البسيط للمخرجات سيفقد المتانة التي توفرها الأدوات. الفكرة الهندسية: عندما يكون تصميم المنتج مستقرًا، ويكون توزيع المدخلات قابلاً للتنبؤ به، وتكون قيود التكلفة كبيرة، فإن التقطير الفوري يعد تحسينًا ممتازًا؛ أثناء الاستكشاف أو قبل أن تستقر المهمة، يظل الاحتفاظ بالتفكير الواضح والمطالبات القابلة للتحرير أمرًا أساسيًا للتكرار السريع.
>
> **التجربة 7-9 ★★★: تقطير سلسلة الأفكار (CoT) `[Extended Experiment]`**
>
> التقطير الفوري يتجاهل عملية التفكير؛ ويؤدي تقطير CoT إلى العكس: فهو ينقل **مسار التفكير الكامل** لنموذج المعلم القوي إلى نموذج الطالب. يمكن أن يؤدي استخلاص CoT من نموذج المعلم القادر إلى تمكين الطالب الذي لديه نفس عدد المعلمات من استعادة 70%-80% من قدرات المعلم. بالنسبة للفرق التي لا تهدف إلى دفع حدود القدرات الحديثة ولكنها تريد نماذج يمكنها التحكم فيها بنفسها، فهذه هي استراتيجية المتابعين الأكثر واقعية. تعد سلسلة النماذج الصغيرة المقطرة مفتوحة المصدر بواسطة DeepSeek-R1 (باستخدام مسارات تفكير R1 لتنفيذ SFT على سلسلة Qwen وLlama) مثالًا تمثيليًا لهذا النهج.
>
...
1. **السؤال الأول: هل هناك حاجة إلى التدريب اللاحق؟** إذا كان من الممكن حل المشكلة من خلال هندسة الأدوات (تحسين المطالبات، وتصميم الأدوات، وإدارة السياق)، فلا حاجة إلى تدريب نموذجي. تقع معظم تطبيقات الوكيل هنا.
...
## التعلم المعزز أحادي المنعطف: مقارنة بين الذاكرة والتعميم
...
>
> جنبًا إلى جنب مع التقطير الفوري، يشكل AdaptThink "نظامًا مزدوجًا سريعًا وبطيئًا": يقلل التقطير من نسبة المهام التي تتطلب التفكير، بينما يعمل AdaptThink على تحسين استراتيجية التحفيز للمهام المتبقية، مما يؤدي إلى تعظيم كفاءة التفكير بشكل مشترك.
>
...
>
> يكشف تتبع دقة التعرف البصري أن RL يعمل على تحسين التشفير المرئي الأساسي من خلال التحسين الموجه نحو النتائج، ويرتبط هذا التحسن بشكل كبير بمكاسب الأداء الإجمالية؛ في المقابل، SFT يبالغ في التناسب مع أنماط الرموز المميزة في عملية التفكير، مع إهمال تعلم الرموز المرئية، مما يؤدي إلى انخفاض دقة التعرف.
>
...
2. **تدريب نموذج المكافأة (RM)**: بالنسبة إلى نفس الموجه، اطلب من النموذج إنشاء استجابات متعددة، ويقوم المفسرون البشريون بمقارنتها بشكل ثنائي، للإشارة إلى الاستجابات التي يفضلونها. تدريب نموذج التسجيل باستخدام أزواج التفضيلات هذه، مع هدف التدريب بناءً على نموذج برادلي-تيري:
...
من منظور التنفيذ، تنقسم خوارزميات RL إلى **طرق الاستكشاف عبر الإنترنت** (استكشاف استراتيجيات جديدة من خلال التفاعل مع البيئة) و**طرق التحسين دون اتصال بالإنترنت** (التحسين استنادًا إلى البيانات الموجودة، وأكثر استقرارًا ومباشرة). هنا، نقدم أيضًا المصطلحات الصارمة التي وعدنا بها سابقًا: **تقوم أساليب **On-Policy** بتحديث السياسة باستخدام البيانات المأخوذة حديثًا من نفس السياسة فقط؛ يمكن أيضًا أن تتعلم أساليب **خارج السياسة** من البيانات التي تم إنشاؤها بواسطة سياسات أخرى أو الإصدارات السابقة من السياسة، كما هو الحال في مثال Q-learning المذكور سابقًا. ربط أساليب هذا الفصل بهذا التعريف: SFT هو التعلم بالتقليد خارج نطاق السياسة - تأتي البيانات من المعلم أو العروض التوضيحية البشرية، وليس النموذج نفسه؛ النماذج القياسية لـ PPO وGRPO المستخدمة في تدريب LLM هي على السياسة - تستخدم كل جولة عمليات نشر تم أخذ عينات منها حديثًا بواسطة النموذج الحالي (أي تشغيل النموذج خلال المهمة بأكملها مرة واحدة، مما يؤدي إلى إنشاء مسار كامل من البداية إلى النهاية) للحصول على التحديثات؛ DPO هو تحسين التفضيلات دون الاتصال بالإنترنت، ولا يتضمن أخذ العينات عبر الإنترنت ولا تكرار السياسة الصارمة.
...
وهذا يعني "إيجابي إذا كان أفضل من متوسط المجموعة، وسلبي إذا كان أسوأ" - لا حاجة لشبكة قيمة. وهذا هو بالضبط السبب في أنها أرخص. ملاحظة: الصيغة أعلاه تحذف مصطلح تنظيم KL؛ في التدريب الفعلي، تتم عادةً إضافة عقوبة KL لكل رمز مميز المقدمة في القسم السابق لتقييد السياسة بالقرب من النموذج المرجعي.
...
| الطريقة | اكتب | الفكرة الأساسية | ميزة | عيب | السيناريو المطبق |
|--------------|---------------|---------------|--------------|------------------|-------------------------|
| **تعزيز** | خوارزمية RL عبر الإنترنت | يقوم بتحديث السياسة باستخدام المكافأة النهائية للمسار بأكمله | بسيطة للتنفيذ | التباين العالي والتدريب غير المستقر | خط الأساس النظري؛ نادرًا ما يتم استخدامه مباشرة في شكله الأصلي، ولكن متغيراته مع خطوط الأساس (RLOO، REINFORCE++، وما إلى ذلك) هي من بين التيار الرئيسي الحالي؛ GRPO هو في الأساس تعزيز مع خط أساس نسبي للمجموعة |
| **بابو** | خوارزمية RL عبر الإنترنت | تحديد حجم التحديث لكل خطوة لمنع السياسة من "الخروج عن المسار الصحيح" | مستقر؛ توفر شبكة القيمة تخصيصًا ائتمانيًا أكثر دقة | يتطلب تدريبًا إضافيًا وتخزينًا لشبكة القيمة؛ حساسة للمعلمات المفرطة | وكلاء متعددو المنعطفات، تعيين ائتماني طويل المسار |
| **جربو** | خوارزمية RL عبر الإنترنت | أخذ عينات من مسارات متعددة لنفس المشكلة ومقارنة جودتها النسبية داخل المجموعة | لا حاجة لشبكة القيمة؛ تكلفة منخفضة | يتم تعيين نفس الميزة عبر الاستجابة بأكملها، مما يؤدي إلى تخصيص درجات تقريبية؛ يتطلب مكافآت تميز بين المسارات داخل المجموعة | مهام ذات دورة واحدة أو مهام ذات مسار قصير مع تمييز جيد للمكافأة |
| **حماية حقوق الإنسان** | تحسين التفضيلات دون اتصال بالإنترنت | يحول أزواج التفضيلات مباشرة إلى خسارة تصنيف بمكافأة ضمنية | بسيطة وفعالة للغاية؛ لا حاجة لأخذ العينات عبر الإنترنت | لا يمكن استكشاف سياسات جديدة؛ محدودة بجودة وتغطية بيانات التفضيلات غير المتصلة بالإنترنت | سيناريوهات مع بيانات التفضيلات عالية الجودة الموجودة |
| **كتو** | تحسين التفضيلات دون اتصال بالإنترنت | يحتاج فقط إلى علامة "جيد/سيئ" لعينة واحدة | تكلفة التعليق التوضيحي منخفضة جدًا | إشارة خشنة | سيناريوهات ذات موارد توضيحية محدودة للغاية |
...
على المستوى التشغيلي، **أخذ عينات الرفض هو الإجراء القياسي لدفع "دقة التعليقات التوضيحية" إلى الحد الأقصى**، ويتم إصلاح المسار: لكل موجه، عينة من المرشحين k (في الممارسة العملية k عادة ما تكون من 4 إلى 16) ← الحكم على الصحة باستخدام أداة التحقق المستندة إلى القواعد، أو اختبارات الوحدة، أو إجابة مرجعية (للمهام التي لا تحتوي على أداة تحقق تلقائية، استخدم نموذج مكافأة أو نموذج قوي للتسجيل بدلاً من ذلك) ← احتفظ فقط بالمسارات التي تمر عبر المرشح، وقم بإلغاء تكرارها، وتحديد عدد محدد يتم الاحتفاظ به لكل موجه لمنع انهيار البيانات في بعض المشكلات السهلة ← قم بتشغيل جولة من SFT على البيانات المحتجزة. بمجرد أن يصبح النموذج أقوى، يمكنك إعادة تشكيل النموذج وإعادة تصفيته، والتكرار في هذه الحلقة - وهذه هي بالضبط الحلقة الأساسية لطرق التمهيد مثل STaR وRFT. إنه يحول شعار "جودة البيانات تتفوق على الخوارزميات" إلى خط أنابيب قابل للتنفيذ: لا حاجة إلى خوارزمية جديدة - فقط أداة تحقق موثوقة وميزانية كافية لأخذ العينات.
...
## من دورة واحدة إلى دورة متعددة: تخصيص الائتمان وتصميم المكافآت

### التحدي الأساسي المتمثل في المهام المتعددة الأدوار
...
### مكافأة العملية مقابل مكافأة النتيجة: خيار أساسي للمهام متعددة الأدوار
...
>
> تؤكد النتائج مرة أخرى أن "SFT يحفظ، RL يعمم." القاعدة OOD: تتحسن RL بمقدار +11.0 نقطة مئوية على V-IRL-L، بينما SFT **تتناقص بمقدار 79.5 نقطة مئوية**؛ في V-IRL-VL، تتحسن RL بمقدار +9.3 نقطة مئوية، بينما تنخفض SFT بمقدار 33.2 نقطة مئوية. OOD المرئي: تحسن RL على V-IRL-VL من 16.7% إلى **77.8%** (+61.1 نقطة مئوية)، مع RL الشامل باستخدام نموذج مفتوح المصدر يتجاوز خط الأساس القوي الذي يعتمد على الهندسة السريعة الدقيقة مع نموذج مغلق المصدر؛ انخفض SFT إلى 11.1% (-5.6 نقطة مئوية).
>
...
>
> يكشف تتبع العلاقة بين دقة التعرف البصري والأداء العام أن RL لا يعمل على تحسين "صنع القرار في ضوء نتائج التعرف" فحسب، بل يعمل أيضًا على تحسين "التعرف البصري نفسه" - تنتشر إشارة التحسين الموجهة نحو النتائج بشكل عكسي إلى طبقة الإدراك، مما يدفع المشفر المرئي إلى تعلم تمثيلات الميزات ذات الصلة بالمهمة. في المقابل، يميل SFT إلى الإفراط في الاحتواء في طبقة الاستدلال، وإهمال التعلم في طبقة الإدراك، مما يؤدي إلى الفشل عندما يتغير المظهر البصري.
>
...
**لماذا يعمل - تفسير واحد موحد: التباين داخل المجموعة.** تذكر القسم 7.8: لا تقوم GRPO بتدريب أي شبكة قيمة. وبدلاً من ذلك، فهو يقوم باختبار مجموعة من عمليات طرح G لنفس الموجه ويستخدم **مكانة كل عملية طرح بالنسبة إلى متوسط ​​المجموعة** كميزة له. هذه هي الحقيقة الرياضية: **ميزة GRPO هي في الأساس التباين داخل المجموعة** — إذا تلقت كل عملية طرح في مجموعة **نفس المكافأة بالضبط**، يكون التباين صفرًا، وكل ميزة صفرًا، ولا تساهم المجموعة بأي تدرج على الإطلاق. تم إنشاء تلك المجموعة الكاملة من العينات مقابل لا شيء.

مع مكافآت النتائج فقط، يحدث "مأزق التباين الصفري" حتمًا في سيناريوهين، وهو السيناريو الأكثر شيوعًا في **بداية التدريب ونهايته**:

- **مجموعة الفشل الكامل (التدريب المبكر)**: المهمة صعبة للغاية؛ تفشل جميع عمليات الإطلاق في المجموعة، O هو الكل 0 → التباين داخل المجموعة هو صفر → لا يوجد تدرج. يتكون التدريب المبكر بالكامل تقريبًا من هذه المجموعات، مما يؤدي إلى إهدار عدد كبير من العينات باهظة الثمن.
- **مجموعة النجاح الكامل (التدريب المتأخر)**: تم تعلم المهمة تقريبًا؛ تنجح جميع عمليات الإطلاق في المجموعة، O هو الكل 1 → التباين هو أيضًا صفر → لا يوجد تدرج.

بمعنى آخر، **مكافآت النتائج الخالصة تكون عمياء عند كلا طرفي معدل النجاح**. كانت إجابة المجتمع هي **تجاهل** هذه المجموعات ذات التباين الصفري تمامًا (تشير قطرات العينات الديناميكية الخاصة بـ DAPO إلى ما إذا كانت جميع عمليات الإطلاق صحيحة أو كلها خاطئة). يقلب RLVP السؤال: **بدلاً من التخلص منها، ما هي الإشارة الكثيفة التي يمكنها استعادة التباين المفقود؟** بهذه الطريقة، الإجابة فورية:

- **العقوبة التي يمكن التحقق منها يمكنها دائمًا استعادة التباين.** حتى عندما تفشل كل عملية إطلاق في مجموعة، فإنها عادةً ما تختلف في *كيفية* الفشل — حيث يقوم البعض بتشغيل أوامر مدمرة والبعض الآخر لا يفعل ذلك. أضف العقوبة وستكتسب المجموعة الفاشلة على الفور الاختلافات الداخلية (التباين)؛ التدرج يعود إلى الحياة. نظرًا لأن التحقق من الأفعال السيئة أمر رخيص، **العقوبات هي نصف الحل "الذي يمكن الوصول إليه دائمًا"**.
- **يمكن لمكافأة التقدم التي يمكن التحقق منها (الرصيد الجزئي) استعادة التباين فقط عندما يكون التقدم قابلاً للوصول.** إذا اجتازت بعض عمليات الطرح في مجموعة اختبارين إضافيين أو أثبتت معادلة أخرى، فإنها تختلف في التقدم، ويمكن أن يؤدي +μ إلى إنشاء تباين. ولكن إذا كانت المهمة صعبة للغاية و**تقدم كل عملية إطلاق عالق عند الصفر** (على سبيل المثال، في إصلاح البرامج، لا يمكن لأحد اجتياز أي اختبار مخفي)، فإن إشارة التقدم تكون صفر في كل مكان، مما يؤدي إلى عدم وجود أي تباين، فلا يمكن أن يساعد ذلك. لذلك **مكافآت التقدم هي نصف الحل "المقيد بإمكانية الوصول"**: وفي نظرية الإثبات، حيث يتناقص "عدد الأهداف المراد إثباتها" تدريجيًا، فهي قابلة للوصول ومفيدة؛ في إصلاح البرامج، حيث غالبًا ما يتعذر الوصول إلى "نسبة الاختبارات التي تم اجتيازها"، فهي عديمة الفائدة.
...
**حالة الاستخدام 1: معاقبة المسارات لقابلية النشر - أربعة مبادئ للتصميم.** عندما يتم استخدام Φ كعقوبة لتعليم العميل اتباع القيود، فإن أربعة مبادئ تم التحقق من صحتها من خلال الاستئصال تعالج أربعة مخاطر محددة:

1. **معاقبة "الإجراءات" التي يمكن التحقق منها فقط، وليس "عدم إحراز تقدم". نظرًا لأن "عدم القيام بأي شيء" هي أسهل طريقة لتجنب عقوبة "عدم التقدم"، فهذا من شأنه أن يعلم العميل بشكل مباشر عدم القيام بأي شيء.
2. **مكافآت النتائج هي دائمًا المحرك الأساسي؛ لا يمكن تحسين العقوبات بمفردها.** هناك **فخ تقاعس قاتل**: مع فرض العقوبات فقط وعدم وجود مكافآت على النتيجة، فإن الإستراتيجية المثالية هي "عدم القيام بأي شيء" - عدم حدوث انتهاكات، ولكن أيضًا عدم النجاح. تُظهر عمليات الاستئصال التي وردت في الورقة أن العقوبات البحتة تتسبب في انخفاض معدلات النجاح إلى الصفر في كل بذرة عشوائية**. يجب أن توفر مكافآت النتائج "الدافع" لإكمال المهمة، في حين أن العقوبات ترشد *كيفية* القيام بذلك فقط.
3. **قم بإقران كل عقوبة (−κ) بمكافأة الامتثال المقابلة (+μ).** قم بخصم نقاط مقابل "تعديل ملفات الاختبار"، ولكن أيضًا قم بمكافأة الإجراء المتوافق المتمثل في "إصلاح الخطأ فعليًا لجعله يمر بشكل طبيعي" - امنح العميل مخرجًا، وليس مجرد حصار. يُظهر الإلغاء أن إزالة مكافأة الامتثال المقترنة هذه يؤدي إلى إبطاء عملية تعلم السلوك المتوافق بشكل كبير وزعزعة استقرارها.
...
>
>
> يكون التفكير بالنص الخالص عرضة للأخطاء التراكمية في الحسابات الرقمية الدقيقة، أو العمليات الرمزية، أو حل المعادلات المعقدة (على سبيل المثال، عشر خطوات ضرب متتالية، من المحتمل أن تكون كل منها خاطئة). يوفر مترجمو الكود التحقق الدقيق من خلال واجهة قابلة للتنفيذ. يدمج ReTool التنفيذ في الوقت الفعلي لمترجم التعليمات البرمجية في حلقة التفكير RL، مما يسمح للنموذج بالتعلم بشكل مستقل متى وكيف يتم استخدام الأداة تحت توجيه ردود الفعل على النتائج.
>
...
>
> ينبع الاختلاف الأساسي في تكلفة الوقت بين SFT وRL من اختلاف كثافة المعلومات: يوفر SFT إشارة إشرافية لكل رمز مميز، بينما يوفر RL إشارة نجاح/فشل فقط لكل حلقة. من الناحية العملية، يزداد الوقت لكل خطوة مع طول الاستجابة، ويمكن لعدد قليل من الاستجابات الطويلة للغاية إطالة دورة التدريب بأكملها بشكل كبير.
>
...
## الاستكشاف المتطور لتحسين كفاءة العينة

لقد أظهرت التجارب السابقة، بشكل منهجي، القيمة الأساسية لـ RL في تدريب العملاء - ولكن كل واحد منهم دفع تكلفة عينة باهظة. استغرق تشغيل RL الخاص بـ ReTool أكثر من 200 مرة أطول من تشغيل SFT المقابل - تسعة أيام مقابل ساعة واحدة - وهو ثمن قد لا تتمكن الفرق المحدودة الموارد أو سريعة التكرار من دفعه.
...
وكانت النتائج مذهلة: في مهام مثل الرياضيات، تتطلب مطابقة أداء RL النقي **1/10** تقريبًا من خطوات التدريب. وتتجلى الميزة بشكل أكثر وضوحًا في الاستدلال طويل السلسلة - حيث يشير المعلم إلى الطريق في كل خطوة، يتعلم الطالب بسرعة تصحيح أخطائه بدلاً من الانجراف أكثر في المسار الخاطئ. كما أنه يسهل التجهيز الزائد: في المعيار RL، التدريب المتكرر على نفس الموجه يميل نحو حفظ الإجابة النهائية، في حين أن كل مسار هنا مختلف وتكون تعليقات المعلم خاصة به، لذلك يتعلم الطالب استراتيجية عامة بدلاً من إجابات معينة - ويمكن إعادة استخدام البيانات بشكل أكبر بكثير.
...
إن المبدأ القائل بأن "الإشارات الكثيفة تتفوق على الإشارات المتفرقة" كان له التحقق من صحة نظيفة للغاية في سيناريو الوكيل النقي. ذكر الفصل الثاني، عند مناقشة شريط الحالة، "إحساس العميل بالوقت" - الإلحاح والمثابرة واليقظة - والذي يمكن غرسه في وقت الاستدلال عبر دليل التعليمات. ومع ذلك، فإن دمج هذا الإحساس بالإيقاع مباشرة في أوزان نموذج صغير 8B، دون الاعتماد على المطالبات، يمثل تحديًا بعد التدريب. قام المؤلف والمتعاونون بتجربة DPO ثم أربع وصفات RL على التوالي. سقطت كل من طرق RL الأربعة هذه في وضع الفشل الذي تمت مناقشته سابقًا في هذا الفصل: كانت المكافأة المحظورة قليلة للغاية، وسجلت معظم عمليات الطرح صفرًا، وتم إلغاء الميزة داخل المجموعة (التناثر)؛ التحول إلى مكافأة متدرجة جعل الإشارة أكثر كثافة، ولكن مقياس الوكيل لا يتوافق مع معدل النجاح الفعلي (اختلال الهدف)؛ أدى تسجيل رد المنعطف الأول فقط إلى تشجيع الإجابات القصيرة الروتينية التي كان أداؤها أسوأ في التقييمات متعددة المنعطفات (عدم تطابق شكل الطرح)؛ أخيرًا، بمجرد محاذاة شكل الطرح مع التقييم، بدأت مكافأة التدريب في الارتفاع، لكن السياسة انهارت إلى وضع واحد في بضع خطوات، وحتى مرساة KL الأقوى بأربع مرات لم تتمكن من سحبها للخلف (انهيار التدريب). لم تتجاوز أي من الوصفات سقف SFT. أدى التحول إلى التقطير على أساس السياسة - باستخدام معلم Qwen3-32B المجمد لتوفير توزيعات مستهدفة على مستوى الرمز المميز على مسارات متعددة المنعطفات للطالب - إلى تقارب سلس للتدريب، مع معدلات نجاح في جميع الظروف الأربعة أعلى بنسبة 23 إلى 47 نقطة مئوية من تلك الخاصة بخط الأساس SFT المقابل[^ch7-11]. فشلت أربعة أساليب RL لأسباب مختلفة، في حين نجحت إشارة معلم واحدة كثيفة - مما يوضح نقطة هذا القسم: ما يعطل ما بعد التدريب ليس عادةً وظيفة مكافأة تفتقر إلى الذكاء، بل إشارة تفتقر إلى الكثافة.

### ماذا لو لم يكن هناك معلم أقوى؟ على سياسة التقطير الذاتي
...
بالمقارنة مع RLVR، يتمتع OPSD بميزتين أساسيتين. **أولاً، لم يعد الأمر يعتمد على مكافآت يمكن التحقق منها.** يفترض RLVR وجود أداة تحقق تلقائية، في حين أن مصادر المعلومات المميزة لـ OPSD أوسع بكثير: الإجابات القياسية، ولكن أيضًا مطالبات النظام الأكثر ثراءً، أو العروض التوضيحية البشرية، أو مستندات المجال - أي شيء "يسمح للنموذج، بعد وقوع الحدث، بشرح السلوك الصحيح بوضوح" سيفي بالغرض. **ثانيًا، إشارة الإشراف أكثر كثافة بكثير من إشارة RL.** RL تنتج مكافأة عددية واحدة لكل مسار؛ يوفر OPSD توزيعًا احتماليًا كاملاً في كل موضع على طول المسار، كما أن كفاءة الرمز المميز الخاصة به أفضل بشكل ملحوظ من أساليب RL. ومن العدل أن نقول إن OPSD يستبدل "المعلم الأقوى" بـ "المعلومات المميزة"، وبالتالي أصبح مسارا واقعيا للتخفيف من مشكلة كفاءة العينة.
...
6.  **انهيار دالة القيمة والاستكشاف غير الكافي**—قد يؤدي تقدير القيمة غير الدقيق في PPO إلى تحيز حساب الميزة، مما يظهر على شكل تذبذبات شديدة في منحنى التدريب. يمكن أن تؤدي درجة الحرارة المنخفضة جدًا أو العشوائية غير الكافية إلى احتجاز العامل في الوضع الأمثل المحلي.
...
5. ★★★ إذا كانت لديك ميزانية ثابتة، مثل 10000 دولار أمريكي، لتحسين وكيل خدمة العملاء، فكيف يمكنك تخصيصها بين السياق والمعرفة، والموجهات/المهارات، والقيود البرمجية، والتدريب على المعلمات؟ ما هي العوامل التي ستحدد قرارك؟
