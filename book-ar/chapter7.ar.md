...
>
> *   **مطورو تطبيقات الوكلاء** (لا يحتاجون إلى تدريب النماذج بأنفسهم): ابدأ بقراءة الافتتاحية "التدريب المسبق، SFT، RL: A Three-Stage Panorama" لبناء فهم عالمي. ثم يمكنك تخطي قسمي `[قراءة اختيارية]` التاليين (RL الكلاسيكي وخلفية ما قبل التدريب) والمتابعة من قسم SFT. ركز على إطار القرار الخاص بـ "الفرق الأساسي بين SFT وRL" و"متى تختار SFT مقابل SFT". RL"، بالإضافة إلى الحكم بأن "البيانات والبيئة أكثر أهمية من الخوارزميات" - ستؤثر هذه الأفكار على قرارات التصميم الخاصة بك في هندسة منظومة التشغيل (متى يجب الحل باستخدام الموجّهات، وعندما يكون الضبط الدقيق يستحق ذلك).
> *   **نموذج تدريب المهندسين**: اقرأ بشكل تسلسلي من البداية. يوفر القسمان `[قراءة اختيارية]` خلفية كاملة عن التعلم المعزز والتدريب المسبق. التجارب اللاحقة توفر خطط التدريب استنساخه.
...
1. **معاقبة "الإجراءات" التي يمكن التحقق منها فقط، وليس "عدم إحراز تقدم". نظرًا لأن "عدم القيام بأي شيء" هي أسهل طريقة لتجنب عقوبة "عدم التقدم"، فهذا من شأنه أن يعلم الوكيل بشكل مباشر عدم القيام بأي شيء.
