...
\IfFontExistsTF{Noto Sans Arabic}{%
  ...
  \newfontfamily\arabicfonttt[Script=Arabic,Scale=0.86]{Noto Sans Arabic}%
  \newfontfamily\englishfonttt[Scale=0.86]{Noto Sans Arabic}%
}{%
  \setsansfont[Script=Arabic,Scale=1.0]{Arial}%
  \newfontfamily\arabicfontsf[Script=Arabic,Scale=1.0]{Arial}%
  \newfontfamily\arabicfonttt[Script=Arabic,Scale=0.86]{Arial}%
  \newfontfamily\englishfonttt[Scale=0.86]{Arial}%
}
