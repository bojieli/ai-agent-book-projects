...
**أدوات التنفيذ** هي الوسيلة التي يقوم الوكيل من خلالها بتغيير العالم الخارجي. تتضمن الأمثلة أدوات سطر الأوامر (`shell_exec`)، وأدوات مفسّر الشفرة (`code_interpreter`)، وأدوات كتابة الملفات (`write_file`)، وأدوات تحرير الملفات (`edit_file`)، وأدوات إرسال البريد الإلكتروني (`send_email`). على عكس أدوات الإدراك، يمكن أن تكون تكلفة الأخطاء في أدوات التنفيذ مرتفعة للغاية، مما يجعل القيود الأمنية هي جوهر تصميمها.

**أدوات التعاون** هي الوسائل التي يتعاون الوكيل من خلالها مع الوكلاء الآخرين والبشر. تتضمن الأمثلة إنشاء وكيل فرعي (`spawn_subagent`)، وإرسال رسالة إلى وكيل فرعي (`send_message_to_subagent`)، وإلغاء وكيل فرعي (`cancel_subagent`)، واكتشاف الوكلاء المتوفرين في النظام (`list_agents`). أبسط سبب لحاجة الوكيل إلى التعاون هو التوازي - على سبيل المثال، البحث عن العديد من المؤسسين المشاركين لـ OpenAI في وقت واحد. السبب الأعمق هو التخصص: إعطاء المهام المختلفة نماذج وأدوات وموجّهات وسياقات مختلفة للحصول على نتائج أفضل. سيناقش الفصل العاشر بشكل أكبر البنى متعددة الوكلاء.
