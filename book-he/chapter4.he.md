...
**חשיפה הדרגתית.** עם ההפעלה הסוכן רואה רק קטלוג דק ובו ה‑`name` וה‑`description` של כל Skill, וקורא את תת‑ה‑Skill ואת הקבצים המופנים ממנה רק כשההקשר הנוכחי מחייב זאת — כמו מי שמעיין בספר עזר או בוויקיפדיה ומביט רק בערך שהוא צריך. Skill קלה כל כך לתחזוקה דווקא משום שההיררכיה הזו בנויה בה מלכתחילה.
...
מסקנת הליבה של פרק זה: איכות עיצוב הכלים קובעת את תקרת יכולותיו של הסוכן. ההחלטה הראשונה היא באיזו צורה לבטא יכולת — כברירת מחדל נוטים אל הקצה הכללי, וחוזרים לכלי ייעודי רק בארבעה מצבים: אבטחה והרשאות, פרמטרים מורכבים, תדירות שימוש גבוהה במיוחד, והבדלים בין פלטפורמות. החלטה זו בלתי תלויה ב«כמה יכולות המודל רואה בבת אחת»: הראשונה קובעת את העלות הקבועה של כל יכולת, והשנייה כמה מהן נחשפות בעת ובעונה אחת.
