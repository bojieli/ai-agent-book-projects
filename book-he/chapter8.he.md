...
לאחר אימון הביניים יש להשתמש בערכות הערכה כגון LongBench v2, ‏IFEval והסוכנים מקצה לקצה המתוארים בפרק 7 כדי לוודא ש**יכולת היסוד להקשר ארוך באורכי הקשר שונים** לא אבדה. יכולת ההקשר הארוך היא הבסיס לשרשרת מחשבה ארוכה ולציות להוראות, ואלה בתורן הבסיס ליכולות סוכן מסדר גבוה יותר כגון קריאה לכלים.
...
- **ציות להוראות**: ציות להוראות מורכבות, ובכללן ריבוי הוראות בבת אחת, יישוב סתירות, הקפדה על תהליך החשיבה שנקבע, ועמידה בפורמט הפלט;
- **חשיבה בשרשרת ארוכה**: פתרון בעיות קשות במתמטיקה, בהיסק לוגי ובייצור קוד;
...
‏rollouts שהם on-policy ורעננים באמת מקיימים $\pi_\theta=\mu$ **לפני כל עדכון פרמטרים**, ולכן $\rho_t=1$. הדבר ממקד את האימון ב"מצבים שהמודל הנוכחי אכן נכנס אליהם", וחוסך תיקון בעל שונות גבוהה עבור אי‑התאמת התפלגויות. יתרונותיו של off-policy הם שניתן לעשות שימוש חוזר בנתונים ישנים, שהדגימה והאימון יכולים לרוץ אסינכרונית ושהתפוקה גבוהה יותר; המחיר הוא שככל שהמדיניות מתיישנת, זנב ההתפלגות של $\rho_t$ נעשה כבד יותר. עבור רצפים אוטורגרסיביים ארוכים, תיקון קפדני ברמת הקידומת או המסלול גם מכפיל יחסים רבים ברמת הטוקן, ולכן הטיה קטנה עלולה להצטבר למשקל עצום או אפסי. ה‑clipping של PPO מגביל עדכונים חריגים אך אינו משחזר ללא אובדן את כיסוי ההתפלגות שאבד: חיתוך רב מדי מאבד גרדיאנטים, וחיתוך מועט מדי מאפשר למדגם קטן להשתלט. לפיכך "on-policy עדיף" אינה משפט אוניברסלי; בגרדיאנטי המדיניות של מודלי שפה כיום היא בדרך כלל משמעותה **הטיית התפלגות נמוכה יותר ואופטימיזציה יציבה יותר**. גם מחקרים אמפיריים על ייצוב RL במודלים גדולים מוצאים שהפחתת התיישנות המדיניות והפער בין אימון להסקה היא תנאי חשוב לכך שמטרת הפונדקאות תישאר תקפה[^ch8-32].
