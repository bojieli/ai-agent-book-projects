...
>
> Las cifras de las tres dimensiones anteriores proceden de una única ejecución controlada de pequeña escala y son **observaciones ilustrativas**: lo que establecen es una dirección —la organización y las descripciones de herramientas pesan mucho más que el tono y el estilo—, no una magnitud reproducible. Según el criterio del capítulo 7, una diferencia de una sola ejecución necesita tamaño de muestra y número de repeticiones antes de poder sostener un «cuánto». Al ejecutar este experimento por su cuenta, observe si se mantiene el orden relativo de las tres dimensiones, no si reproduce los mismos puntos porcentuales.
>
>
