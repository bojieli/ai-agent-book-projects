...
Estas tres categorías de información —código, proceso y entorno— constituyen la información mínima que el Agente necesita para trabajar eficazmente. La capacidad inherente del modelo es solo la base; **la calidad del contexto es la verdadera clave de la capacidad del Agente**. Un modelo de capacidad moderada con un contexto cuidadosamente organizado a menudo puede superar a un modelo de primer nivel que opera a ciegas con información insuficiente.
