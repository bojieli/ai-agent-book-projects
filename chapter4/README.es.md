...
| 4-2 | [execution-tools](execution-tools/) | ✅ | Herramientas MCP de ejecución: operaciones de archivos, intérprete de código, terminal virtual e integración externa |
| 4-3 | [collaboration-tools](collaboration-tools/) | ✅ | Herramientas MCP de colaboración: automatización de navegador, HITL, notificaciones y temporizadores |
| 4-4 | [agent-with-event-trigger](agent-with-event-trigger/) | ✅ | Agente FastAPI orientado a eventos con integración asíncrona de herramientas MCP |
| 4-5 | [async-agent](async-agent/) | ✅ | Marco Flux orientado a eventos asíncronos monohilo con colas por prioridad e interrupción |
| 4-6 | [active-tool-discovery](active-tool-discovery/) | ✅ | Comparación entre inyección completa de esquemas e inyección bajo demanda mediante meta-herramientas |
